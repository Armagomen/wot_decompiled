...
from last_stand_common.last_stand_constants import PLAYERS_TEAM, ATTACK_REASON, OBELISK_ROLE_TAG
from last_stand.gui.sounds import ComponentsHolder
from last_stand.gui.sounds.vehicle_components import LSCommonEnemySounds, LSLootSounds, LSObeliskSounds
from last_stand.gui.sounds.sound_constants import VEHICLE_OBJ_NAME_PATTERN
from skeletons.gui.battle_session import IBattleSessionProvider
_VEHICLE_SOUND_COMPONENTS = [
 (
  LSCommonEnemySounds, lambda parent: parent.isEnemy),
 (
  LSLootSounds, lambda parent: not parent.isEnemy),
 (
  LSObeliskSounds, lambda parent: OBELISK_ROLE_TAG in parent.entity.typeDescriptor.type.tags)]
...
class LSVehicleSoundComponent(DynamicScriptComponent):
    ...
    def onDamageReceived(self, attackerID, attackReasonID, damage):
        attackReason = ATTACK_REASON.getValue(attackReasonID)
        self._components.call('onDamageReceived', attackerID, attackReason, damage)
