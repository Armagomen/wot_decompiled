...
class Comp7VOIPController(IComp7VOIPController):
    __slots__ = ('__messageShown', '__cooldownCallback', '__isTeamChannelAvailable')
    __sessionProvider = dependency.descriptor(IBattleSessionProvider)

    def __init__(self, isTeamChannelAvailable):
        super(Comp7VOIPController, self).__init__()
    ...
    def __getMessage(self):
        ...
        resStr = R.strings.comp7_ext.battleMessages
