...
_HANGAR_LOADING_STATES = [
 'LOGIN', 'CONNECTED', 'SHOW GUI', 'QUESTS SYNC', 'USS SYNC', 'SPACE LOADING START',
 'VEHICLE LOADING START', 'VEHICLE LOADING END', 'SPACE LOADING END',
 'HANGAR UI READY', 'TRAINING UI READY',
 'HANGAR READY', 'TUTORIAL LOADING START', 'TUTORIAL LOADING END', 'DISCONNECTED']
