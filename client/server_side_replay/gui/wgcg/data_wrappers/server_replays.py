...
ShortReplay = NamedTuple('ShortReplay', [
 (
  'rank', int),
 (
  'replay_id', int),
...
PageReplays = NamedTuple('PageReplays', [
 (
  'rankings', List[ShortReplay]),
 (
  'total_entries', int),
 (
  'limit', int),
 (
  'offset', int)])
TopReplays = NamedTuple('TopReplays', [
 (
  'exp', ShortReplay),
 (
...
ReplayLink = NamedTuple('ReplayLink', [
 (
  'replay_link', str),
 (
  'expire_time', int)])