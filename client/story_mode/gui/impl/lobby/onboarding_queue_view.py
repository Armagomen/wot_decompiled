...
from story_mode.gui.impl.gen.view_models.views.lobby.onboarding_queue_view_model import OnboardingQueueViewModel
...
class OnboardingQueueView(BaseWaitQueueView):
    ...
    LAYOUT_ID = R.views.story_mode.mono.lobby.onboarding_queue_view()
