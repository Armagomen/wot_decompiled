...
from story_mode.gui.impl.gen.view_models.views.lobby.badge_tooltip_view_model import BadgeTooltipViewModel
...
class BadgeTooltip(ViewImpl):
    ...
    def __init__(self, badgeId):
        settings = ViewSettings(R.views.story_mode.mono.lobby.tooltips.badge_tooltip(), model=BadgeTooltipViewModel())
