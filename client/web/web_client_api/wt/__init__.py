...
from gui.impl.lobby.wt_event.wt_event_sound import playLootboxBackToPortalsExitEvent
...
class WtWebApi(W2CSchema):
    ...
    def showEventStorageWindow(self, _):
        ...
        def predicate(window):
            return window.content is not None and getattr(window.content, 'layoutID',
                                                          None) == R.views.lobby.wt_event.WtEventPortal()
