...
class BaseRespawnsController(ViewComponentsController):
    ...
    def __init__(self, setup):
        super(BaseRespawnsController, self).__init__()
    ...
    def setViewComponents(self, *components):
        super(BaseRespawnsController, self).setViewComponents(*components)
    ...
    def respawnPlayer(self):
        LOG_ERROR('respawnPlayer not Implemented')

    def chooseVehicleForRespawn(self, intCD):
        LOG_ERROR('chooseVehicleForRespawn not Implemented')

    def sendSwitchVehSetupsLayout(self, vehCD, groupID, layoutIdx):
        LOG_ERROR('sendSwitchVehSetupsLayout not Implemented')
    ...
    def updateRespawnInfo(self, respawnInfo):
        ...
        self.__respawnInfo = _RespawnInfo(intCD, respawnInfo['manualRespawnPiT'], respawnInfo['autoRespawnPiT'], respawnInfo['respawnZones'], respawnInfo['chosenRespawnZone'], unpackVehSetupsIndexes(list(respawnInfo['vehSetupsIndexes'])))
    ...
    def _show(self):
        ...
        if not self.__isUIInited:
            ...
            for viewCmp in self._viewComponents:
                viewCmp.start(self.__vehicles, False)
