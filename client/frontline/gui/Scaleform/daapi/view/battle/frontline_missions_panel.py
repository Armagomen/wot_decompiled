...
class FrontlineMissionsPanel(FrontlineMissionsPanelMeta, CallbackDelayer):
    sessionProvider = dependency.descriptor(IBattleSessionProvider)

    def __init__(self):
        FrontlineMissionsPanelMeta.__init__(self)
    ...
    def _populate(self):
        FrontlineMissionsPanelMeta._populate(self)
    ...
    def _dispose(self):
        ...
        FrontlineMissionsPanelMeta._dispose(self)
