...
class FrontlineReinforcementPanel(FrontlineReinforcementPanelMeta, IArenaPeriodController):
    sessionProvider = dependency.descriptor(IBattleSessionProvider)

    def __init__(self):
        super(FrontlineReinforcementPanel, self).__init__()
    ...
    def _populate(self):
        super(FrontlineReinforcementPanel, self)._populate()
    ...
    def _dispose(self):
        super(FrontlineReinforcementPanel, self)._dispose()
