...
class EpicSkillSlotSetupInfoTooltip(BlocksTooltipData):
    ...
    def _packBlocks(self, vehicleCD=None):
        ...
        blocks.append(formatters.packImageBlockData(img=backport.image(R.images.frontline.gui.maps.icons.tooltips.battleAbility.dyn(vType)()), align=BLOCKS_TOOLTIP_TYPES.ALIGN_CENTER))
        ...
        blocks.append(formatters.packImageTextBlockData(desc=desc, img=backport.image(R.images.frontline.gui.maps.icons.tooltips.battleAbility.open()), txtAlign=BLOCKS_TOOLTIP_TYPES.ALIGN_CENTER, txtOffset=20, imgPadding=formatters.packPadding(top=-10, left=-10), padding=formatters.packPadding(top=4)))
        ...
        blocks.append(formatters.packImageTextBlockData(desc=desc, img=backport.image(R.images.frontline.gui.maps.icons.tooltips.battleAbility.upgrade()), txtAlign=BLOCKS_TOOLTIP_TYPES.ALIGN_CENTER, txtOffset=20, imgPadding=formatters.packPadding(top=-10, left=-10), padding=formatters.packPadding(top=0)))
