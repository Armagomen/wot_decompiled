...
class FrontlineMinimapComponent(FrontlineMinimapMeta):
    __settingsCore = dependency.descriptor(ISettingsCore)

    def __init__(self):
        super(FrontlineMinimapComponent, self).__init__()
        self.__mode = None
    ...
    def _populate(self):
        super(FrontlineMinimapComponent, self)._populate()
    ...
    def _dispose(self):
        self.__settingsCore.onSettingsApplied -= self.__onSettingsApplied
        super(FrontlineMinimapComponent, self)._dispose()
