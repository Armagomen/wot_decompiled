...
class FrontlineRespawnView(FrontlineRespawnViewMeta, IFrontlineRespawnView):
    ...
    def __init__(self):
        super(FrontlineRespawnView, self).__init__()
    ...
    def _onUnregisterFlashComponent(self, viewPy, alias):
        if alias == FRONTLINE_BATTLE_VIEW_ALIASES.FRONTLINE_BATTLE_TANK_CAROUSEL:
            ...
            self.__ammunitionPanel = None
        super(FrontlineRespawnView, self)._onUnregisterFlashComponent(viewPy, alias)
        return

    def _populate(self):
        super(FrontlineRespawnView, self)._populate()
    ...
    def _dispose(self):
        ...
        self.__lastRespawnPositions = _DEFAULT_RESPAWN_POSITIONS
        super(FrontlineRespawnView, self)._dispose()
        return
