...
class _FrontlineLocalizationProvider(sn_items.LocalizationProvider):
...
class _FrontlineSmokeMixin(object):
...
class FrontlineDeathZoneDamagingSN(_FrontlineLocalizationProvider, sn_items.DeathZoneDamagingSN):
    pass


class FrontlineDeathZoneDangerSN(_FrontlineLocalizationProvider, sn_items.DeathZoneDangerSN):
    pass


class FrontlineDeathZoneWarningSN(_FrontlineLocalizationProvider, sn_items.DeathZoneWarningSN):
    pass


class FrontlineHealingSN(_FrontlineLocalizationProvider, sn_items.HealingSN):
    pass


class FrontlineHealingCooldownSN(_FrontlineLocalizationProvider, sn_items.HealingCooldownSN):
    pass


class FrontlineRepairingSN(_FrontlineLocalizationProvider, sn_items.RepairingSN):
    pass


class FrontlineRepairingCooldownSN(_FrontlineLocalizationProvider, sn_items.RepairingCooldownSN):
    pass


class FrontlineInspireSN(_FrontlineLocalizationProvider, sn_items.InspireSN):

    def _getIsPulseVisible(self):
        return True


class FrontlineInspireCooldownSN(_FrontlineLocalizationProvider, sn_items.InspireCooldownSN):
    pass


class FrontlineInspireSourceSN(_FrontlineLocalizationProvider, sn_items.InspireSourceSN):

    def _getIsPulseVisible(self):
        return True


class FrontlineInspireInactivationSourceSN(_FrontlineLocalizationProvider, sn_items.InspireInactivationSourceSN):
    pass


class FrontlineSmokeSN(_FrontlineLocalizationProvider, _FrontlineSmokeMixin, sn_items.SmokeSN):
...
class FrontlineEnemySmokeSN(_FrontlineLocalizationProvider, _FrontlineSmokeMixin, sn_items.EnemySmokeSN):
...
class FrontlineEnemySmokePostEffectSN(_FrontlineLocalizationProvider, _FrontlineSmokeMixin, sn_items.EnemySmokeSN):
...
class CaptureBlockSN(_FrontlineLocalizationProvider, sn_items.TimerSN):
...
class _StealthBaseSN(_FrontlineLocalizationProvider, sn_items.BuffSN):
