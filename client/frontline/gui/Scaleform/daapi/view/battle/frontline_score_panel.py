...
from frontline.gui.Scaleform.daapi.view.meta.FrontlineScorePanelMeta import FrontlineScorePanelMeta
...
class FrontlineScorePanel(FrontlineScorePanelMeta):
    sessionProvider = dependency.descriptor(IBattleSessionProvider)

    def __init__(self):
        super(FrontlineScorePanel, self).__init__()
    ...
    def _populate(self):
        super(FrontlineScorePanel, self)._populate()
    ...
    def _dispose(self):
        ...
        if arena is not None:
            arena.onPeriodChange -= self.__onArenaPeriodChange
        super(FrontlineScorePanel, self)._dispose()
        return
