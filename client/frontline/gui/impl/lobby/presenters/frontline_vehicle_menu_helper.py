...
from frontline.gui.impl.lobby.presenters.frontline_vehicle_menu_easy_equip_presenter import FrontlineEasyEquipMenuEntrySubPresenter
...
class FrontlineHangarVehicleMenuHelper(IHangarVehicleMenuHelper):
    ...
    def getMenuEntries(cls):
        ...
        return {vehicleMenu.Customization(): CustomizationEntrySubPresenter, 
           ...
           vehicleMenu.EasyEquip(): FrontlineEasyEquipMenuEntrySubPresenter, 
