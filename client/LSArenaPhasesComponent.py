...
class LSArenaPhasesComponent(DynamicScriptComponent):
    ...
    onCleanBCMarkersRequested = Event.Event()
    ...
    def onDestroy(self):
        ...
        self.onCleanBCMarkersRequested.clear()
    ...
    def getInstance():
        if not isPlayerAvatar():
            ...
            if not player.arena or not player.arena.arenaInfo:
                return
            return getattr(player.arena.arenaInfo, 'LSArenaPhasesComponent', None)
