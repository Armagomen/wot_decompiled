...
# Embedded file name: halloween/scripts/client/halloween/gui/game_control/halloween_shop_controller.py
import Event
...
class HalloweenShopController(IHalloweenShopController):
    ...
    def onLobbyStarted(self, ctx):
        super(HalloweenShopController, self).onLobbyStarted(ctx)
        self._initBundles()
