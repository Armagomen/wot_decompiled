...
# Embedded file name: halloween/scripts/client/halloween/gui/sounds/halloween_sound_controller.py
import BattleReplay
import SoundGroups
import WWISE
...
from halloween.gui.sounds.sound_constants import SoundLanguage, HW_ENTER_EVENT, HW_EXIT_EVENT, HW_SOUND_REMAPPING
