...
# Embedded file name: halloween/scripts/client/halloween/gui/impl/gen/view_models/views/common/bonus_item_view_model.py
...
class BonusItemViewModel(ViewModel):
    ...
    def getIsRewardShined(self):
        return self._getBool(8)

    def setIsRewardShined(self, value):
    ...
    def _initialize(self):
        ...
        self._addBoolProperty('isRewardShined', False)
