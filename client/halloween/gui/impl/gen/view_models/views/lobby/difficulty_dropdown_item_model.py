...
# Embedded file name: halloween/scripts/client/halloween/gui/impl/gen/view_models/views/lobby/difficulty_dropdown_item_model.py
...
class DifficultyDropdownItemModel(ViewModel):
    ...
    def _initialize(self):
        ...
        self._addBoolProperty('showWarningIcon', False)
