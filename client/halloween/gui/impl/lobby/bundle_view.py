...
# Embedded file name: halloween/scripts/client/halloween/gui/impl/lobby/bundle_view.py
...
class BundleView(BaseView):
    ...
    def __init__(self, layoutID=R.views.halloween.mono.lobby.bundles_shop(), artefactID=''):
