...
class HWVehicleStatsBlock(base.StatsBlock):
    __slots__ = ('playerDBID', 'playerName', 'vehicleName', 'vehicleType', 'vehicleCD', 'vehicleLvl', 'clanAbbrev', 'artefactKeys', 'isPlayer', 'squadID', 'isOwnSquad', 'killerName', 'deathReason', 'kills', 'damageDealt', 'badgeID', 'badgeSuffixID', 'hwVehiclesRespawnCount', 'hasPenalties', 'hwBossFightDamage')
...
class HWBattlesTeamStatsBlock(base.StatsBlock):
    ...
    def setRecord(self, result, reusable):
        allies, _ = reusable.getBiDirectionTeamsIterator(result, sortKey=lambda info: (HWAfkSortKey(info),
