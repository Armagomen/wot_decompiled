...
# Embedded file name: halloween/scripts/client/halloween/gui/scaleform/daapi/view/battle/battle_timers.py
import BigWorld
...
class PreBattleTimer(battle_timers.PreBattleTimer):
    ...
    def _getMessage(self):
        ...
        difficulty = backport.text(R.strings.halloween_battle.prebattle.difficulty.num(self._arenaBonusType)())
        return backport.text(R.strings.halloween_battle.prebattle.description.title(), difficulty=difficulty)
