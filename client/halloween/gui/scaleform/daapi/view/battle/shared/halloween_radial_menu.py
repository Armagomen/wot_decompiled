...
# Embedded file name: halloween/scripts/client/halloween/gui/scaleform/daapi/view/battle/shared/halloween_radial_menu.py
...
REGULAR_UPPER_STATIC_SHORTCUTS = (Shortcut(title=RADIAL_MENU_CONSTS.EMPTY_BUTTON_STATE, action=RADIAL_MENU_CONSTS.EMPTY_BUTTON_STATE, icon=RADIAL_MENU_CONSTS.EMPTY_BUTTON_STATE, groups=HW_RADIAL_MENU_CONSTS.WHITE_TARGET_STATES, bState=RADIAL_MENU_CONSTS.EMPTY_BUTTON_STATE, indexInGroup=RADIAL_MENU_CONSTS.ELEMENT_INDEX_FIFTH),
 ...
 Shortcut(title='#halloween.halloween_battle:radialMenu/move_to_soul_collector', action=BATTLE_CHAT_COMMAND_NAMES.MOVING_TO_TARGET_POINT, icon=HW_RADIAL_MENU_CONSTS.HW_COLLECTOR, groups=[HW_RADIAL_MENU_CONSTS.TARGET_STATE_HW_COLLECTOR], bState=RADIAL_MENU_CONSTS.NORMAL_BUTTON_STATE, indexInGroup=RADIAL_MENU_CONSTS.ELEMENT_INDEX_FIRST),
 Shortcut(title='#halloween.halloween_battle:radialMenu/attention_here', action=BATTLE_CHAT_COMMAND_NAMES.MOVE_TO_TARGET_POINT, icon=HW_RADIAL_MENU_CONSTS.HW_COLLECTOR_HELP, groups=[HW_RADIAL_MENU_CONSTS.TARGET_STATE_HW_COLLECTOR], bState=RADIAL_MENU_CONSTS.NORMAL_BUTTON_STATE, indexInGroup=RADIAL_MENU_CONSTS.ELEMENT_INDEX_SIXTH),
 Shortcut(title='#halloween.halloween_battle:radialMenu/move_to_camp', action=BATTLE_CHAT_COMMAND_NAMES.MOVING_TO_TARGET_POINT, icon=HW_RADIAL_MENU_CONSTS.HW_CAMP, groups=[HW_RADIAL_MENU_CONSTS.TARGET_STATE_HW_CAMP], bState=RADIAL_MENU_CONSTS.NORMAL_BUTTON_STATE, indexInGroup=RADIAL_MENU_CONSTS.ELEMENT_INDEX_FIRST),
 Shortcut(title='#halloween.halloween_battle:radialMenu/attention_here', action=BATTLE_CHAT_COMMAND_NAMES.MOVE_TO_TARGET_POINT, icon=HW_RADIAL_MENU_CONSTS.HW_CAMP_HELP, groups=[HW_RADIAL_MENU_CONSTS.TARGET_STATE_HW_CAMP], bState=RADIAL_MENU_CONSTS.NORMAL_BUTTON_STATE, indexInGroup=RADIAL_MENU_CONSTS.ELEMENT_INDEX_SIXTH))
...
class HalloweenRadialMenu(RadialMenu):
    ...
    def _getCanReplayShortcut(self, shortcut, canReplyAction):
        return Shortcut(title='#halloween.halloween_battle:radialMenu/confirm', action=canReplyAction, icon=RADIAL_MENU_CONSTS.YES, groups=HW_RADIAL_MENU_CONSTS.WHITE_TARGET_STATES, bState=RADIAL_MENU_CONSTS.NORMAL_BUTTON_STATE, indexInGroup=shortcut.indexInGroup) if shortcut.action == BATTLE_CHAT_COMMAND_NAMES.MOVING_TO_TARGET_POINT else super(HalloweenRadialMenu, self)._getCanReplayShortcut(shortcut, canReplyAction)
