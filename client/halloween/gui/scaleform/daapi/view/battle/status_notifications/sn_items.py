...
class PhaseFinishSN(_HalloweenLocalizationProvider, TimerSN):
    ...
    def _getDescription(self, value):
        ...
        return backport.text(self._stringResource.phaseEnd()) if isCollectorFull else ''
...
class HWPersonalDeathZoneIgniteSN(HWPersonalDeathZoneSN):
...
class HWPersonalDeathZoneStunSN(HWPersonalDeathZoneSN):
...
class HWPersonalDeathZoneIntervalSN(HWPersonalDeathZoneSN):
