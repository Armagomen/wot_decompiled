...
# Embedded file name: halloween/scripts/client/halloween/gui/scaleform/daapi/view/meta/BattleHintMeta.py
...
class BattleHintMeta(BaseDAAPIComponent):
    ...
    def as_clearPinnableHintS(self):
        return self.flashObject.as_clearPinnableHint() if self._isDAAPIInited() else None
