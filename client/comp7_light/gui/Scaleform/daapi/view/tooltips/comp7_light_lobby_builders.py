...
def getTooltipBuilders():
    return (
     DataBuilder(COMP7_LIGHT_TOOLTIPS.COMP7_LIGHT_SELECTOR_INFO, TOOLTIPS_CONSTANTS.BLOCKS_DEFAULT_UI, Comp7LightSelectorTooltip(contexts.ToolTipContext(None))),
