...
SERVER_FORMATTERS = {_SM_TYPE.serverReboot.index(): _sc.ServerRebootFormatter(),
                     ...
                     _SM_TYPE.hangarQuests.index(): _sc.TokenQuestsFormatter(
                      subFormatters=_HANGAR_QUESTS_SUB_FORMATTERS),
                     ...
                     _SM_TYPE.lootBoxesAutoOpenReward.index(): _sc.LootBoxAutoOpenFormatter(
                      subFormatters=_AUTO_BOXES_SUB_FORMATTERS),
...
CLIENT_FORMATTERS = {SCH_CLIENT_MSG_TYPE.SYS_MSG_TYPE: _sc.ClientSysMessageFormatter(),
                     ...
                     SCH_CLIENT_MSG_TYPE.WOTPLUS_GOLDRESERVE_ENABLED: _wotPlusFormatters.SimpleFormatter(
                      'GoldReserveEnabledMessage'),
                     SCH_CLIENT_MSG_TYPE.WOTPLUS_GOLDRESERVE_DISABLED: _wotPlusFormatters.SimpleFormatter(
                      'GoldReserveDisabledMessage'),
                     SCH_CLIENT_MSG_TYPE.WOTPLUS_PASSIVEXP_ENABLED: _wotPlusFormatters.SimpleFormatter(
                      'PassiveXpEnabledMessage'),
                     SCH_CLIENT_MSG_TYPE.WOTPLUS_PASSIVEXP_DISABLED: _wotPlusFormatters.SimpleFormatter(
                      'PassiveXpDisabledMessage'),
                     SCH_CLIENT_MSG_TYPE.WOTPLUS_TANKRENTAL_ENABLED: _wotPlusFormatters.SimpleFormatter(
                      'TankRentalEnabledMessage'),
                     SCH_CLIENT_MSG_TYPE.WOTPLUS_TANKRENTAL_DISABLED: _wotPlusFormatters.SimpleFormatter(
                      'TankRentalDisabledMessage'),
                     SCH_CLIENT_MSG_TYPE.WOTPLUS_FREEDIRECTIVES_ENABLED: _wotPlusFormatters.SimpleFormatter(
                      'FreeDirectivesEnabledMessage'),
                     SCH_CLIENT_MSG_TYPE.WOTPLUS_FREEDIRECTIVES_DISABLED: _wotPlusFormatters.SimpleFormatter(
                      'FreeDirectivesDisabledMessage')}
