...
class SCH_CLIENT_MSG_TYPE(object):
    SYS_MSG_TYPE, PREMIUM_ACCOUNT_EXPIRY_MSG, AOGAS_NOTIFY_TYPE, ACTION_NOTIFY_TYPE, BATTLE_TUTORIAL_RESULTS_TYPE, KOREA_PARENTAL_CONTROL_TYPE, TECH_TREE_ACTION_DISCOUNT, BLUEPRINTS_CONVERT_SALE, MAPBOX_PROGRESSION_REWARD, MAPBOX_SURVEY_AVAILABLE, MAPBOX_EVENT_ENDED, MAPBOX_EVENT_STARTED, BATTLE_MATTERS_PAUSED, BATTLE_MATTERS_STARTED, BATTLE_MATTERS_TOKEN_AWARD, BATTLE_MATTERS_BATTLE_AWARD, WOTPLUS_GOLDRESERVE_ENABLED, WOTPLUS_GOLDRESERVE_DISABLED, WOTPLUS_PASSIVEXP_ENABLED, WOTPLUS_PASSIVEXP_DISABLED, WOTPLUS_TANKRENTAL_DISABLED, WOTPLUS_TANKRENTAL_ENABLED, WOTPLUS_FREEDIRECTIVES_DISABLED, WOTPLUS_FREEDIRECTIVES_ENABLED, INTEGRATED_AUCTION_LOST_RATE = range(25)
