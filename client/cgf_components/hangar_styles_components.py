...
# Embedded file name: scripts/client/cgf_components/hangar_styles_components.py
import CGF
import SoundGroups
...
class StyleMarkersManager(CGF.ComponentManager):
    ...
    def _addMarker(self, styleID, flashMarkerComponent, transformComponent):
        ...
        event = events.LobbyMarkerEvents(events.LobbyMarkerEvents.ADD_MARKER, ctx={'entityID': styleID,
         'markerComponent': flashMarkerComponent,
         'matrix': matrix})
