...
SpecBattleGuiSettings = namedtuple('SpecBattleGuiSettings', ('bonusType', 'modifiersGetter',
                                                             ...
                                                             'vehicleMenuHelper'))
DEFAULT_SPEC_GUI_SETTINGS = SpecBattleGuiSettings(ARENA_BONUS_TYPE.UNKNOWN, EmptyHangarDynamicGuiProvider.getDefaultBattleModifiers, DefaultLobbyHeaderHelper, DefaultMissionsGuiHelper, DefaultHangarVehicleMenuHelper)
...
class SpecBattleHangarDynamicGuiProvider(BaseHangarDynamicGuiProvider):
    ...
    def getVehicleMenuHelper(self):
        return self._guiSettings.vehicleMenuHelper
