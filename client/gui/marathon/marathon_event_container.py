...
class MarathonEventContainer(object):
    ...
    def _initialize(self):
        self.awardTokens = tuple(
            (AWARD_TOKENS_FORMAT.format(self.tokenPrefix, postfix) for postfix in self.awardTokensPostfix))
        self.postAwardTokens = tuple(
            (AWARD_TOKENS_FORMAT.format(self.tokenPrefix, postfix) for postfix in self.awardPostTokensPostfix))
