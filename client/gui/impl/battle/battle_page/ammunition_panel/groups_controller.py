...
from gui.impl.battle.battle_page.ammunition_panel.blocks_controller import PrebattleAmmunitionBlocksController, \
    RespawnAmmunitionBlocksController
from gui.impl.gen.view_models.views.battle.battle_page.prebattle_ammunition_items_group import \
    PrebattleAmmunitionItemsGroup
...
COMMAND_MAPPING = {
    CommandMapping.CMD_AMMUNITION_SHORTCUT_SWITCH_SETUP_1: AmmunitionPanelConstants.OPTIONAL_DEVICES_AND_BOOSTERS,
...
class RespawnAmmunitionGroupsController(AmmunitionGroupsController):
    ...
    def _getGroups(self):
        ...
        return FRONTLINE_GROUPS if arenaGuiType in (
        ARENA_GUI_TYPE.EPIC_BATTLE, ARENA_GUI_TYPE.EPIC_TRAINING) else RANDOM_GROUPS
