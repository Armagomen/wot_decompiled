...
PERSONAL_RESOURCE_ORDER = [
 GOODIE_RESOURCE_TYPE.XP, GOODIE_RESOURCE_TYPE.CREDITS, GOODIE_RESOURCE_TYPE.FREE_XP_CREW_XP]
...
PREMIUM_BOOSTER_IDS = PR2BoosterIDs.ADVANCED_ITEMS + PR2BoosterIDs.EXPIRABLE_ADVANCED_ITEMS
