...
from gui.impl.lobby.tank_setup.configurations.opt_device import OptDeviceTabsController, OptDeviceSelectedFilters, \
    getOptDeviceTabByItem, OptDeviceIntroductionController, OptDeviceTabs
