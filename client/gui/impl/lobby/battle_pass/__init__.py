...
def getBusinessHandlers():
    return (
     BattlePassPackageBusinessHandler(),)
...
class BattlePassPackageBusinessHandler(PackageBusinessHandler):
    ...
    def __init__(self):
        listeners = (
         (
          VIEW_ALIAS.BATTLE_PASS, self.loadViewByCtxEvent),
         (
          VIEW_ALIAS.BATTLE_PASS_BROWSER, self.loadViewByCtxEvent),
         (
          VIEW_ALIAS.BATTLE_PASS_VIDEO_BROWSER, self.loadViewByCtxEvent))
