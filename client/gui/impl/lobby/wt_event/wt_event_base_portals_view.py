...
class WtEventBasePortalsView(ViewImpl):
    __slots__ = ()
    _eventCtrl = dependency.descriptor(IGameEventController)
    ...
    def createToolTipContent(self, event, contentID):
        ...
        return WtEventBuyLootBoxesTooltipView() if contentID == R.views.lobby.wt_event.tooltips.WtEventBuyLootBoxesTooltipView() else super(
            WtEventBasePortalsView, self).createToolTipContent(event, contentID)
    ...
    def _addListeners(self):
        ...
        g_eventBus.addListener(events.WtEventPortalsEvent.ON_VEHICLE_AWARD_VIEW_CLOSED, self._onPortalAwardsViewClose,
    ...
    def _removeListeners(self):
        ...
        if app:
            app.containerManager.onViewAddedToContainer -= self.__onViewAddedToContainer
        g_eventBus.removeListener(events.WtEventPortalsEvent.ON_VEHICLE_AWARD_VIEW_CLOSED,
                                  self._onPortalAwardsViewClose, EVENT_BUS_SCOPE.LOBBY)
