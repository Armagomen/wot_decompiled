...
from gui.impl.gen.view_models.views.lobby.wt_event.wt_event_characteristics_panel_view_model import \
    WtEventCharacteristicsPanelViewModel, PropertyModel
...
class WTEventCharacteristicsPanelView(ViewImpl):
    ...
    def __init__(self, *args, **kwargs):
        settings = ViewSettings(layoutID=R.views.lobby.wt_event.WTEventCharacteristicsPanel(),
                                flags=ViewFlags.COMPONENT, model=WtEventCharacteristicsPanelViewModel())
        settings.args = args
    ...
    def createToolTipContent(self, event, contentID):
        ...
        return WtEventVehicleParamsTooltipView(parameter=parameter) if parameter is not None else super(
            WTEventCharacteristicsPanelView, self).createToolTipContent(event, contentID)
