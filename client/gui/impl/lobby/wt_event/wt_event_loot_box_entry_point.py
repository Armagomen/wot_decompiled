...
from gui.impl.gen.view_models.views.lobby.wt_event.wt_event_loot_box_entry_point_model import \
    WtEventLootBoxEntryPointModel
...
class LootboxesEntrancePointWidget(ViewImpl):
    ...
    def __init__(self, *args, **kwargs):
        settings = ViewSettings(R.views.lobby.wt_event.WTEventBoxEntryPoint(), flags=ViewFlags.COMPONENT,
                                model=WtEventLootBoxEntryPointModel())
        settings.args = args
    ...
    def createToolTipContent(self, event, contentID):
        return WtEventLootBoxesTooltipView() if contentID == R.views.lobby.wt_event.tooltips.WtEventLootBoxesTooltipView() else super(
            LootboxesEntrancePointWidget, self).createToolTipContent(event, contentID)
