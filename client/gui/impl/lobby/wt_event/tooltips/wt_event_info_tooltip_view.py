...
from gui.impl.gen.view_models.views.lobby.wt_event.tooltips.wt_event_info_tooltip_view_model import \
    WtEventInfoTooltipViewModel
...
class WtEventInfoTooltipView(ViewImpl):
    ...
    def __init__(self, *args, **kwargs):
        settings = ViewSettings(layoutID=R.views.lobby.wt_event.tooltips.WtEventInfoTooltipView(),
                                model=WtEventInfoTooltipViewModel())
        settings.args = args
