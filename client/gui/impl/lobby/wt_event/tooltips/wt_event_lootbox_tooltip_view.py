...
from gui.impl.gen.view_models.views.lobby.wt_event.tooltips.wt_event_lootbox_tooltip_view_model import \
    WtEventLootboxTooltipViewModel
...
class WtEventLootBoxTooltipView(ViewImpl):
    ...
    def __init__(self, *args, **kwargs):
        settings = ViewSettings(layoutID=R.views.lobby.wt_event.tooltips.WtEventLootBoxTooltipView(),
                                model=WtEventLootboxTooltipViewModel())
        settings.args = args
