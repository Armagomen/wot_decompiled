...
from gui.impl.gen.view_models.views.lobby.wt_event.tooltips.wt_event_buy_lootboxes_tooltip_view_model import \
    WtEventBuyLootboxesTooltipViewModel
...
class WtEventBuyLootBoxesTooltipView(ViewImpl):
    ...
    def __init__(self, *args, **kwargs):
        settings = ViewSettings(layoutID=R.views.lobby.wt_event.tooltips.WtEventBuyLootBoxesTooltipView(),
                                model=WtEventBuyLootboxesTooltipViewModel())
        settings.args = args
