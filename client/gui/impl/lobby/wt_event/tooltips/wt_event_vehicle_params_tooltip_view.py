...
from gui.impl.gen.view_models.views.lobby.wt_event.tooltips.wt_event_vehicle_params_tooltip_view_model import \
    WtEventVehicleParamsTooltipViewModel
...
class WtEventVehicleParamsTooltipView(ViewImpl):
    ...
    def __init__(self, *args, **kwargs):
        settings = ViewSettings(layoutID=R.views.lobby.wt_event.tooltips.WtEventVehicleParamsTooltipView(),
                                model=WtEventVehicleParamsTooltipViewModel())
        settings.args = args
