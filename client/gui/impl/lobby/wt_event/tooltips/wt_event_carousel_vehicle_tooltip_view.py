...
from gui.impl.gen.view_models.views.lobby.wt_event.tooltips.wt_event_carousel_vehicle_tooltip_view_model import \
    WtEventCarouselVehicleTooltipViewModel
...
class WtEventCarouselVehicleTooltipView(ViewImpl):
    ...
    def __init__(self, *args, **kwargs):
        settings = ViewSettings(layoutID=R.views.lobby.wt_event.tooltips.WtEventCarouselVehicleTooltipView(),
                                model=WtEventCarouselVehicleTooltipViewModel())
        settings.args = args
