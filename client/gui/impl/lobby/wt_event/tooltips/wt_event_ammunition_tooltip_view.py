...
from gui.impl.gen.view_models.views.lobby.wt_event.tooltips.wt_event_ammunition_tooltip_view_model import \
    WtEventAmmunitionTooltipViewModel
...
class WtEventAmmunitionTooltipView(ViewImpl):
    ...
    def __init__(self, *args, **kwargs):
        settings = ViewSettings(layoutID=R.views.lobby.wt_event.tooltips.WtEventAmmunitionTooltipView(),
                                model=WtEventAmmunitionTooltipViewModel())
        settings.args = args
    ...
    def _onLoading(self, *args, **kwargs):
        ...
        with self.viewModel.transaction() as trx:
            ...
            if item.itemTypeID == GUI_ITEM_TYPE.SHELL:
                ...
                cooldownStr = _COOLDOWN_TEMPLATE.format(
                    backport.text(R.strings.menu.moduleInfo.params.cooldownSeconds()), item.descriptor.cooldownSeconds,
                    ms(backport.msgid(R.strings.menu.tank_params.no_brackets.s())))
