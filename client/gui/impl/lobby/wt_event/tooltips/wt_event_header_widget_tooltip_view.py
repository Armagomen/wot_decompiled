...
from gui.impl.gen.view_models.views.lobby.wt_event.tooltips.wt_event_header_widget_tooltip_view_model import \
    WtEventHeaderWidgetTooltipViewModel, PerformanceRisk
