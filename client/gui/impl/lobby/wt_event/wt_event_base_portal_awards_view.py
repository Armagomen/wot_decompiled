...
class WtEventBasePortalAwards(ViewImpl):
    ...
    def createToolTipContent(self, event, contentID):
        ...
        return WtEventBuyLootBoxesTooltipView() if contentID == R.views.lobby.wt_event.tooltips.WtEventBuyLootBoxesTooltipView() else super(
            WtEventBasePortalAwards, self).createToolTipContent(event, contentID)
    ...
    def _addListeners(self):
        ...
        self.viewModel.onBackToStorage += self._goToStorage
    ...
    def _onClose(self):
        self._eventCtrl.getLootBoxAreaSoundMgr().leave()
        g_eventBus.handleEvent(events.WtEventPortalsEvent(events.WtEventPortalsEvent.ON_ALL_PORTAL_VIEWS_CLOSED),
