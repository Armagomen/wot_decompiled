...
class WtEventVehiclePortal(WtEventBasePortalAwards):
    ...
    def __init__(self, awards=None, vehicleSource=None):
        settings = ViewSettings(layoutID=R.views.lobby.wt_event.WtEventVehiclePortal(),
                                model=WtEventVehiclePortalModel())
    ...
    def _goToStorage(self):
        g_eventBus.handleEvent(events.WtEventPortalsEvent(events.WtEventPortalsEvent.ON_VEHICLE_AWARD_VIEW_CLOSED),
...
class WtEventVehiclePortalWindow(LobbyWindow):
    ...
    def __init__(self, awards, vehicleSource, parent=None):
        super(WtEventVehiclePortalWindow, self).__init__(wndFlags=WindowFlags.WINDOW | WindowFlags.WINDOW_FULLSCREEN,
                                                         content=WtEventVehiclePortal(awards,
