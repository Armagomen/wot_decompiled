...
class WTEventCollectionView(ViewImpl):
    ...
    def __init__(self, *args, **kwargs):
        settings = ViewSettings(layoutID=R.views.lobby.wt_event.WTEventCollections(),
                                flags=ViewFlags.LOBBY_TOP_SUB_VIEW, model=WtEventCollectionViewModel())
        settings.args = args
    ...
    def _onLoaded(self, *args, **kwargs):
        ...
        g_eventBus.handleEvent(events.LobbyHeaderMenuEvent(events.LobbyHeaderMenuEvent.TOGGLE_VISIBILITY,
    ...
    def __updateViewModel(self):
        ...
        with self.viewModel.transaction() as model:
            ...
            hunterItemsSeen, numHunterItemsNew = self.__fillCollection(hunterCollection, model.hunterCollection,
                                                                       previousItemsSeen, offset=0)
            bossItemsSeen, numBossItemsNew = self.__fillCollection(bossCollection, model.bossCollection,
                                                                   previousBossSeen, offset=len(hunterCollection))
