...
from gui.impl.gen.view_models.views.lobby.eleventh_birthday_calendar.shop_birthday_section_entry_point_view_model import \
    ShopBirthdaySectionEntryPointViewModel
