...
from gui.impl.gen.view_models.views.lobby.battle_matters.battle_matters_entry_point_view_model import \
    BattleMattersEntryPointViewModel, State
...
class BattleMattersEntryPointView(ViewImpl):
    ...
    def createToolTipContent(self, event, contentID):
        return BattleMattersEntryTooltipView() if contentID == R.views.lobby.battle_matters.tooltips.BattleMattersEntryTooltipView() else super(
            BattleMattersEntryPointView, self).createToolTipContent(event, contentID)
    ...
    def _getEvents(self):
        return (
        (self.viewModel.onClick, self.__onClick), (self.__battleMattersController.onStateChanged, self.__update),
