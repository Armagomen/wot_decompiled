...
from gui.impl.gen.view_models.views.lobby.battle_matters.battle_matters_paused_view_model import \
    BattleMattersPausedViewModel
...
class BattleMattersPausedView(ViewImpl):
    ...
    def _getEvents(self):
        return ((self.viewModel.gotoHangar, self.__gotoHangar),
