...
# Embedded file name: scripts/client/gui/impl/gen/view_models/views/lobby/cn_loot_boxes/china_loot_boxes_open_box_screen_model.py
from enum import Enum, IntEnum

from frameworks.wulf import ViewModel
from gui.impl.gen.view_models.views.lobby.cn_loot_boxes.reward_model import RewardModel
from gui.impl.gen.view_models.views.lobby.cn_loot_boxes.vehicle_model import VehicleModel
...
class ChinaLootBoxesOpenBoxScreenModel(ViewModel):
    ...
    def __init__(self, properties=16, commands=6):
        super(ChinaLootBoxesOpenBoxScreenModel, self).__init__(properties=properties, commands=commands)
    ...
    def _initialize(self):
        super(ChinaLootBoxesOpenBoxScreenModel, self)._initialize()
