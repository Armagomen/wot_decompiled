...
def createAndLoadBackportTooltipWindow(parentWindow, tooltip=None, isSpecial=False, tooltipId=None, specialArgs=None):
    tooltipData = createTooltipData(tooltip=tooltip, isSpecial=isSpecial, specialAlias=tooltipId,
...
def createBackportTooltipContent(specialAlias=None, specialArgs=None, isSpecial=True, tooltip=None):
    return _BackportTooltipContent(createTooltipData(tooltip, isSpecial, specialAlias, specialArgs or []))
    ...
    def _initialize(self, tooltipData, event=None):
        ...
        if toolTipMgr is not None:
            if tooltipData.isWulfTooltip:
                ...
                toolTipMgr.onCreateWulfTooltip(tooltipData.specialAlias, tooltipData.specialArgs, posX, posY,
