...
from gui.server_events.events_helpers import getEventsData, getRerollTimeout, isBattleRoyale, isDailyEpic, \
    isBattleMattersQuestID, isMapsTraining, isMarathon, isPremium, isRankedDaily, isRankedPlatform
...
class EventsCache(IEventsCache):
    ...
    def __getCommonQuestsIterator(self):
        ...
        for questDescr in motiveQuests:
            yield (
            questDescr.questID, self._makeQuest(questDescr.questID, questDescr.questData, maker=_motiveQuestMaker))
