...
class EventBattleSquadEntryPoint(SquadEntryPoint):
    ...
    def makeDefCtx(self):
        return SquadSettingsCtx(PREBATTLE_TYPE.EVENT, waitingID='prebattle/create',
...
class EventBattleSquadEntity(SquadEntity):
    ...
    def getConfirmDialogMeta(self, ctx):
        ...
        return None if not ctrl.isModeActive() or not ctrl.isHangarAvailable() else super(EventBattleSquadEntity,
                                                                                          self).getConfirmDialogMeta(
            ctx=ctx)
