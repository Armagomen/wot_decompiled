...
class UNIT_RESTRICTION(object):
    ...
    WHEELED_IS_FULL = 61
    WHEELED_IS_FORBIDDEN = 62
    MEDIUMTANK_IS_FULL = 63
    MEDIUMTANK_IS_FORBIDDEN = 64
    HEAVYTANK_IS_FULL = 65
    ...
    CLASSES_RESTRICTIONS = (
     SPG_IS_FULL, SPG_IS_FORBIDDEN,
     SCOUT_IS_FULL, SCOUT_IS_FORBIDDEN,
     WHEELED_IS_FULL, WHEELED_IS_FORBIDDEN,
     AT_SPG_IS_FULL, AT_SPG_IS_FORBIDDEN,
     HEAVYTANK_IS_FULL, HEAVYTANK_IS_FORBIDDEN,
     MEDIUMTANK_IS_FULL, MEDIUMTANK_IS_FORBIDDEN)
