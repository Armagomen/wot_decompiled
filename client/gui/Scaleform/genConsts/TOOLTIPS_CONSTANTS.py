...
class TOOLTIPS_CONSTANTS(object):
    ...
    HANGAR_CAROUSEL_VEHICLE = 'hangarCarouselVehicle'
    ...
    CONTEXT_VEHICLE_MODULE = 'contextVehicleModule'
    ARMOR_INSPECTOR_SHELL = 'armorInspectorShell'
    AWARD_DEMOUNT_KIT = 'awardDemountKit'
    NOT_ENOUGH_MONEY = 'notEnoughMoney'
    CREW_PERK_GF = 'crewPerkGf'
    CREW_PERK_ALT_GF = 'crewPerkAltGf'
    ...
    FRONTLINE_RANDOM_RESERVE = 'FLRandomReserve'
    FRONTLINE_BATTLE_ABILITY = 'frontlineBattleAbility'
    SPECIAL = 'special'
    SIMPLE = 'simple'
    COMPLEX = 'complex'
    WULF = 'wulf'
    ...
    EASY_TANK_EQUIP_VEHICLE_ADVANCED_PARAMETERS = 'easyTankEquipVehicleAdvancedParameters'
    ...
    PERSONAL_MISSIONS_POINTS = 'personalMissionsPoints'
    PERSONAL_MISSION_OPERATION_DISABLED = 'personalMissionOperationDisabled'
    GF_TEST_TOOLTIP = 'gfTestTooltip'
    RESEARCH_BUTTON = 'ResearchButton'
    SKILLS_EFFICIENCY = 'skillsEfficiency'
    EMPTY_SKILL_GF = 'emptySkillGf'
    ...
    CRYSTAL_INFO_SIMPLE = 'crystalInfoSimple'
    CREDITS_INFO_SIMPLE = 'creditsInfoSimple'
    GOLD_INFO_SIMPLE = 'goldInfoSimple'
    FREEXP_INFO_SIMPLE = 'freeXPInfoSimple'
    EXCHANGE_RATE_LIMITED_DISCOUNT_INFO = 'exchnageRateLimitedDiscountInfo'
    EXCHANGE_RATE_DISCOUNT_INFO = 'exchnageRateDiscountInfo'
    ...
    SERVERS_INFO_UI = 'ToolTipInblocksDefaultUI'
    ...
    SETTINGS_KEY_SPECIAL_ABILITY = 'SettingKeySpecialAbility'
    SETTINGS_KEY_SPECIAL_ABILITY_UI = 'ToolTipInblocksDefaultUI'
    ...
    SETTINGS_SITUATIONAL_PERK = 'SettingsSituationalPerk'
    ...
    ADVENT_CALENDAR_TANKMAN_NOT_RECRUITED = 'adventCalendarTankmanNotRecruited'
    ADVENT_CALENDAR_CUSTOMIZATION_ITEM = 'adventCalendarCustomizationItem'
    ...
    TANKMAN_SET = [TANKMAN, TANKMAN_NOT_RECRUITED, BATTLE_ROYALE_TANKMAN, CREW_PERK_GF, CREW_PERK_ALT_GF, CREW_SKILL_UNTRAINED, COMMANDER_BONUS, SKILLS_EFFICIENCY, SPECIAL_TANKMAN, EMPTY_SKILL_GF, MENTOR_ASSIGNMENT, MENTOR_LICENSE]
    ...
    FRONTLINE_LOBBY_SET = [EPIC_SKILL_INFO, EPIC_SKILL_SLOT_INFO, EPIC_SKILL_SLOT_SETUP_INFO, EPIC_QUESTS_PREVIEW, EPIC_BATTLE_COMPLETED_QUESTS_INFO, EPIC_BATTLE_SELECTOR_INFO, EPIC_BATTLE_CALENDAR_INFO, EPIC_BATTLE_WIDGET_INFO, EPIC_BATTLE_RECERTIFICATION_FORM_TOOLTIP, EPIC_BATTLE_INSTRUCTION_TOOLTIP, FRONTLINE_COUPON, FRONTLINE_RANK, FRONTLINE_BATTLE_ABILITY]
