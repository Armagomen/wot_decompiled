...
class TOOLTIPS_CONSTANTS(object):
    ...
    EVENT_LOOT_BOXES_VEHICLE_BLUEPRINT_FRAGMENT = 'eventLootBoxesVehicleBlueprintFragment'
    ...
    EPIC_BATTLE_SET = [EPIC_SKILL_INFO,
     ...
     EPIC_BATTLE_RECERTIFICATION_FORM_TOOLTIP,
    ...
    TUTORIAL_SET = [HANGAR_TUTORIAL_CUSTOMIZATION_TYPES,
     ...
     HANGAR_TUTORIAL_PERSONAL_CASE_FREE_SKILLS,
    ...
    FRONTLINE_BATTLE_SET = [FRONTLINE_RANDOM_RESERVE]
    ...
    ROYALE_LOBBY_SET = [BATTLE_ROYALE_VEHICLE,
     ...
     BATTLE_ROYALE_SELECTOR_CALENDAR_INFO,
    ...
    FUN_RANDOM_LOBBY_SET = [FUN_RANDOM_CALENDAR_DAY,
     FUN_RANDOM_MODE_SELECTOR_CALENDAR_DAY,
     FUN_RANDOM_CAROUSEL_VEHICLE,
     FUN_RANDOM_REWARDS]
    REFERRAL_PROGRAM_SET = [REFERRAL_AWARDS]
    RESOURCE_WELL_SET = [RESOURCE_WELL_GOLD,
