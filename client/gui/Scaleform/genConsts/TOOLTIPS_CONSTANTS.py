...
class TOOLTIPS_CONSTANTS(object):
    ...
    BATTLE_PASS_3D_NOT_CHOOSEN = 'battlePass3dNotChoosen'
    ...
    COMMON_SET = [IGR_INFO,
     ...
     BATTLE_PASS_NOT_STARTED,
     BATTLE_PASS_3D_NOT_CHOOSEN,
     TECHTREE_DISCOUNT_INFO,
     TECHTREE_NATION_DISCOUNT,
     DOG_TAGS_INFO,
     CRYSTAL_INFO_FULL_SCREEN,
    ...
    CUSTOMIZATION_SET = [TECH_CUSTOMIZATION_ITEM,
     ...
     TECH_CUSTOMIZATION_FANTASTICAL_ITEM,
    ...
    EPIC_BATTLE_SET = [EPIC_SKILL_INFO,
     ...
     EPIC_SKILL_SLOT_SETUP_INFO,
     EPIC_QUESTS_PREVIEW,
     EPIC_BATTLE_COMPLETED_QUESTS_INFO,
     EPIC_BATTLE_SELECTOR_INFO,
     EPIC_BATTLE_CALENDAR_INFO,
     EPIC_BATTLE_WIDGET_INFO]
    ...
    SETTINGS_SET = [SETTINGS_CONTROL,
                    ...
                    SETTINGS_SHOW_LOCATION_MARKERS,
                    SETTINGS_KEY_CHARGE_FIRE,
                    SETTINGS_SWITCH_EQUIPMENT]
    ...
    BLUEPRINTS_SET = [BLUEPRINT_INFO,
     ...
     BLUEPRINT_RANDOM_NATIONAL_INFO]
    ...
    TRADE_IN_SET = [TRADE_IN_INFO,
     TRADE_IN_INFO_NOT_AVAILABLE,
     TRADE_IN_STATE_NOT_AVAILABLE,
     PERSONAL_TRADE_IN_INFO]
