...
class PILLBOX_SIEGE_WIDGET_CONST(object):
    ...
    PILLBOX_SIEGE_MECHANICS_WIDGET_STATE = [IDLE, SIEDGE, PILLBOX, IDLE_TO_SIEDGE, IDLE_TO_PILLBOX, SIEDGE_TO_IDLE, SIEDGE_TO_PILLBOX, PILLBOX_TO_IDLE, PILLBOX_TO_SIEDGE]
    PILLBOX_SIEGE_TRANSITIONS_STATE = [IDLE_TO_SIEDGE, IDLE_TO_PILLBOX, SIEDGE_TO_IDLE, SIEDGE_TO_PILLBOX, PILLBOX_TO_IDLE, PILLBOX_TO_SIEDGE]
