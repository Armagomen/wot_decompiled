...
class EPIC_BATTLE(object):
    ...
    RANK_CREWROLESFACTORSELF = '#epic_battle:rank/crewRolesFactorSelf'
    RANK_CREWROLESFACTORPROMOTION = '#epic_battle:rank/crewRolesFactorPromotion'
    RANK_CREWROLESFACTORPROMOTION1 = '#epic_battle:rank/crewRolesFactorPromotion1'
    RANK_RECERVEUNLOCKED = '#epic_battle:rank/recerveUnlocked'
    RANK_RESERVEUPGRADED = '#epic_battle:rank/reserveUpgraded'
    RANK_ALLRESERVEUPGRADED = '#epic_battle:rank/allReserveUpgraded'
    RANK_SLOTUNLOCKED = '#epic_battle:rank/slotUnlocked'
    RANK_SLOT_2 = '#epic_battle:rank/slot_2'
    RANK_SLOT_3 = '#epic_battle:rank/slot_3'
    ...
    TAB_SCREEN_GENERALBONUSVALUE = '#epic_battle:tab_screen/generalBonusValue'
    TAB_SCREEN_GENERALBONUSDESCR = '#epic_battle:tab_screen/generalBonusDescr'
    ...
    ABILITYINFO_PARAMS_ARCADE_MINEFIELD_EPIC_BATTLE_ACTIVATIONDELAY = '#epic_battle:abilityInfo/params/arcade_minefield_epic_battle/activationDelay'
    ...
    PLAYER_ERRORS_EQUIPMENT_ISWORKING = '#epic_battle:player_errors/equipment/isWorking'
    ...
    SELECTORTOOLTIP_EPICBATTLE_ENDED_BODY = '#epic_battle:selectorTooltip/epicBattle/ended/body'
    ...
    WIDGETALERTMESSAGEBLOCK_FINISHED = '#epic_battle:widgetAlertMessageBlock/finished'
    WIDGETALERTMESSAGEBLOCK_MODIFICATION = '#epic_battle:widgetAlertMessageBlock/modification'
    WIDGETALERTMESSAGEBLOCK_DETAILS = '#epic_battle:widgetAlertMessageBlock/details'
    WIDGETALERTMESSAGEBLOCK_TOOLTIP_BODY = '#epic_battle:widgetAlertMessageBlock/tooltip/body'
    ...
    TOOLTIPS_END = '#epic_battle:tooltips/end'
    ...
    TOOLTIPS_SLOTSETUPINFO_RESERVE_PURCHASED = '#epic_battle:tooltips/slotSetupInfo/reserve/purchased'
    TOOLTIPS_SLOTSETUPINFO_RESERVE_LOCKED = '#epic_battle:tooltips/slotSetupInfo/reserve/locked'
    TOOLTIPS_CHOOSEREWARDS_DESC = '#epic_battle:tooltips/chooseRewards/desc'
    STATUSNOTIFICATIONTIMERS_DEATHZONE = '#epic_battle:statusNotificationTimers/deathZone'
    STATUSNOTIFICATIONTIMERS_SMOKE_ALLY = '#epic_battle:statusNotificationTimers/smoke/ally'
    STATUSNOTIFICATIONTIMERS_SMOKE_ENEMY = '#epic_battle:statusNotificationTimers/smoke/enemy'
    STATUSNOTIFICATIONTIMERS_SMOKE_ENEMYPOSTEFFECT = '#epic_battle:statusNotificationTimers/smoke/enemyPostEffect'
    STATUSNOTIFICATIONTIMERS_HEALPOINT_HEALING = '#epic_battle:statusNotificationTimers/healPoint/healing'
    STATUSNOTIFICATIONTIMERS_HEALPOINT_HEALED = '#epic_battle:statusNotificationTimers/healPoint/healed'
    STATUSNOTIFICATIONTIMERS_REPAIRPOINT = '#epic_battle:statusNotificationTimers/repairPoint'
    STATUSNOTIFICATIONTIMERS_INSPIRE_INSPIRED = '#epic_battle:statusNotificationTimers/inspire/inspired'
    STATUSNOTIFICATIONTIMERS_INSPIRE_INSPIRING = '#epic_battle:statusNotificationTimers/inspire/inspiring'
    STATUSNOTIFICATIONTIMERS_CAPTUREBLOCK_BLOCKED = '#epic_battle:statusNotificationTimers/captureBlock/blocked'
    STATUSNOTIFICATIONTIMERS_STEALTHRADAR_ACTIVE = '#epic_battle:statusNotificationTimers/stealthRadar/active'
    STATUSNOTIFICATIONTIMERS_STEALTHRADAR_INACTIVE = '#epic_battle:statusNotificationTimers/stealthRadar/inactive'
    DIALOGS_TITLE_BUY_ITEM = '#epic_battle:dialogs/title/buy/item'
    ...
    SKILL_CATEGORY_TACTICS = '#epic_battle:skill/category/tactics'
    AMMUNITIONSETUP_BTN_INFO_HINT = '#epic_battle:ammunitionSetup/btn/info/hint'
    RESERVE_LEVEL_1 = '#epic_battle:reserve/level/1'
