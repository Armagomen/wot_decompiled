...
class STORAGE(object):
    ...
    STORAGE_BALANCELABEL = '#storage:storage/balanceLabel'
    ...
    BLUEPRINTS_NOITEMS_RECEIVE_HEADER = '#storage:blueprints/noItems/receive/header'
    BLUEPRINTS_NOITEMS_RECEIVE_BODY = '#storage:blueprints/noItems/receive/body'
    BLUEPRINTS_NOITEMS_FILL_HEADER = '#storage:blueprints/noItems/fill/header'
    BLUEPRINTS_NOITEMS_FILL_BODY = '#storage:blueprints/noItems/fill/body'
    BLUEPRINTS_NOITEMS_DISCOUNT_HEADER = '#storage:blueprints/noItems/discount/header'
    BLUEPRINTS_NOITEMS_DISCOUNT_BODY = '#storage:blueprints/noItems/discount/body'
    BLUEPRINTS_TITLE = '#storage:blueprints/title'
    BLUEPRINTS_NATIONBAR_TITLE = '#storage:blueprints/nationBar/title'
    BLUEPRINTS_CAROUSEL_TITLE = '#storage:blueprints/carousel/title'
    BLUEPRINTS_BUTTONLABEL_GOTOBLUEPRINTS = '#storage:blueprints/buttonLabel/gotoblueprints'
    ...
    CUSTOMIZATIONSUITABLEFORALL_LABEL = '#storage:customizationSuitableForAll/label'
    STYLEPREVIEW_TOOLTIP = '#storage:stylePreview/tooltip'
    ...
    DEVICES_FILTERS_ALL = '#storage:devices/filters/all'
    DEVICES_FILTERS_SIMPLE = '#storage:devices/filters/simple'
    DEVICES_FILTERS_DELUXE = '#storage:devices/filters/deluxe'
    DEVICES_FILTERS_TROPHY = '#storage:devices/filters/trophy'
    DEVICES_FILTERS_MODERNIZED = '#storage:devices/filters/modernized'
    OFFERS_SECTIONTITLE = '#storage:offers/sectionTitle'
    OFFERS_GIFTSTITLE = '#storage:offers/giftsTitle'
