...
class DIALOGS(object):
    ...
    ACCOUNTCOMPLETION_WARNINGSERVERISMISSING = '#dialogs:accountCompletion/warningServerIsMissing'
    ...
    ACCOUNTCOMPLETION_EMAILISTOSHORT = '#dialogs:accountCompletion/emailIsToShort'
    ACCOUNTCOMPLETION_EMAILISTOLONG = '#dialogs:accountCompletion/emailIsToLong'
    ...
    ALL_ENUM = (INTERVIEWQUIT_TITLE,
                ...
                ACCOUNTCOMPLETION_WARNINGSERVERISMISSING,
                ...
                ACCOUNTCOMPLETION_EMAILISTOSHORT,
                ACCOUNTCOMPLETION_EMAILISTOLONG,
