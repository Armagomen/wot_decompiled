...
class LobbyVehicleMarkerView(LobbyVehicleMarkerViewMeta):
    ...
    def _dispose(self):
        ...
        self.removeListener(events.LobbyHeaderMenuEvent.TOGGLE_VISIBILITY, self.__onToggleVisibility,
    ...
    def addCgfMarker(self, entityId, markerComponent, matrix):
        flashMarker = self.as_createCustomMarkerS(entityId, markerComponent.icon.replace('gui', '..'),
                                                  makeString(markerComponent.textKey))
