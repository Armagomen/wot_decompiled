...
from account_helpers.AccountSettings import ACTIVE_TEST_PARTICIPATION_CONFIRMED, AccountSettings, \
    KNOWN_SELECTOR_BATTLES, LAST_SHOP_ACTION_COUNTER_MODIFICATION, NEW_LOBBY_TAB_COUNTER, NEW_SHOP_TABS, \
    OVERRIDEN_HEADER_COUNTER_ACTION_ALIASES, QUESTS, QUEST_DELTAS, QUEST_DELTAS_COMPLETION, RECRUIT_NOTIFICATIONS
...
from gui.Scaleform.daapi.view.lobby.header.fight_btn_tooltips import getComp7BattlesOnlyVehicleTooltipData, \
    getComp7FightBtnTooltipData, getEpicBattlesOnlyVehicleTooltipData, getEpicFightBtnTooltipData, getEventTooltipData, \
    getFunRandomFightBtnTooltipData, getMapboxFightBtnTooltipData, getMapsTrainingTooltipData, getPreviewTooltipData, \
    getRandomTooltipData, getRankedFightBtnTooltipData, getSandboxTooltipData, getSquadFightBtnTooltipData
...
from gui.Scaleform.daapi.view.lobby.store.browser.shop_helpers import getBuyGoldUrl, getBuyPremiumUrl, \
    getBuyRenewableSubscriptionUrl, isSubscriptionEnabled
...
from gui.shared.event_dispatcher import hideWebBrowserOverlay, showActiveTestConfirmDialog, showModeSelectorWindow, \
    showShop, showStorage
...
from shared_utils import BitmaskHelper, CONST_CONTAINER, first
from skeletons.account_helpers.settings_core import ISettingsCore
from skeletons.connection_mgr import IConnectionManager
from skeletons.gui.battle_matters import IBattleMattersController
from skeletons.gui.game_control import IAnonymizerController, IBadgesController, IBattleRoyaleController, \
    IBoostersController, IBootcampController, IChinaController, IClanNotificationController, IComp7Controller, \
    IEpicBattleMetaGameController, IEventBattlesController, IFunRandomController, IGameSessionController, \
    IIGRController, IMapboxController, IMapsTrainingController, IPlatoonController, IRankedBattlesController, \
    IServerStatsController, ISteamCompletionController, IUISpamController, IWalletController
...
class LobbyHeader(LobbyHeaderMeta, ClanEmblemsHelper, IGlobalListener):
    ...
    def _addListeners(self):
        ...
        self.__funRandomController.onGameModeStatusUpdated += self.__updateFunRandom
    ...
    def isEventEnabled(self):
        ...
        return not self.bootcampController.isInBootcamp() and (self.rankedController.isAvailable() or self.__funRandomController.isAvailable() or isEpicBattleAvailabe or brAvailable or mapboxAvailable or isEventBattlesAvailable)
