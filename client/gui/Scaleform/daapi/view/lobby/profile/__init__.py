...
def getViewSettings():
    ...
    from gui.Scaleform.daapi.view.lobby.profile.ProfileAchievementPage import ProfileAchievementPage
    ...
    return (
     ...
     ComponentSettings(VIEW_ALIAS.PROFILE_ACHIEVEMENTS_PAGE, ProfileAchievementPage, ScopeTemplates.DEFAULT_SCOPE),
