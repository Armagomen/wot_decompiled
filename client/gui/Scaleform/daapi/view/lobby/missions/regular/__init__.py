...
def getViewSettings():
    ...
    return (ViewSettings(VIEW_ALIAS.LOBBY_MISSIONS, MissionsPage, 'missionsPage.swf', WindowLayer.SUB_VIEW, VIEW_ALIAS.LOBBY_MISSIONS, ScopeTemplates.LOBBY_SUB_SCOPE),
            ...
            ViewSettings(EVENTBOARDS_ALIASES.EVENTBOARDS_DETAILS_BATTLE_VIEW, EventBoardsDetailsBattleView,
                         'eventBoardsDetails.swf', WindowLayer.TOP_SUB_VIEW,
                         EVENTBOARDS_ALIASES.EVENTBOARDS_DETAILS_BATTLE_VIEW, ScopeTemplates.LOBBY_SUB_SCOPE, True),
            ComponentSettings(EVENTBOARDS_ALIASES.EVENTBOARDS_DETAILS_BROWSER_ALIAS, EventBoardsBrowserOverlay,
                              ScopeTemplates.VIEW_SCOPE),
            ComponentSettings(EVENTBOARDS_ALIASES.EVENTBOARDS_DETAILS_VEHICLES_ALIAS, EventBoardsVehiclesOverlay,
                              ScopeTemplates.VIEW_SCOPE),
            ComponentSettings(EVENTBOARDS_ALIASES.EVENTBOARDS_DETAILS_BATTLE_ALIAS, EventBoardsBattleOverlay,
                              ScopeTemplates.DEFAULT_SCOPE),
            ComponentSettings(EVENTBOARDS_ALIASES.EVENTBOARDS_DETAILS_AWARDS_ALIAS, EventBoardsAwardsOverlay,
                              ScopeTemplates.DEFAULT_SCOPE),
            ComponentSettings(QUESTS_ALIASES.MISSIONS_GROUPED_VIEW_PY_ALIAS, MissionsGroupedView,
                              ScopeTemplates.VIEW_SCOPE),
            ComponentSettings(QUESTS_ALIASES.MISSIONS_PREMIUM_VIEW_PY_ALIAS, DailyQuestsInjectorView,
                              ScopeTemplates.VIEW_SCOPE),
            ComponentSettings(QUESTS_ALIASES.MISSIONS_MARATHON_VIEW_PY_ALIAS, MissionsMarathonView,
                              ScopeTemplates.VIEW_SCOPE),
            ComponentSettings(QUESTS_ALIASES.BATTLE_PASS_MISSIONS_VIEW_PY_ALIAS, BattlePassViewsHolderComponent,
                              ScopeTemplates.VIEW_SCOPE),
            ComponentSettings(QUESTS_ALIASES.MAPBOX_VIEW_PY_ALIAS, MapboxProgressionsComponent,
                              ScopeTemplates.VIEW_SCOPE),
            ComponentSettings(QUESTS_ALIASES.BATTLE_MATTERS_VIEW_PY_ALIAS, BattleMattersMissionComponent,
                              ScopeTemplates.VIEW_SCOPE),
            ComponentSettings(QUESTS_ALIASES.MISSIONS_EVENT_BOARDS_VIEW_PY_ALIAS, MissionsEventBoardsView,
                              ScopeTemplates.VIEW_SCOPE),
            ComponentSettings(QUESTS_ALIASES.MISSIONS_CATEGORIES_VIEW_PY_ALIAS, MissionsCategoriesView,
                              ScopeTemplates.VIEW_SCOPE),
            ComponentSettings(QUESTS_ALIASES.CURRENT_VEHICLE_MISSIONS_VIEW_PY_ALIAS, CurrentVehicleMissionsView,
                              ScopeTemplates.VIEW_SCOPE),
            ComponentSettings(QUESTS_ALIASES.MISSIONS_VEHICLE_SELECTOR_ALIAS, RegularMissionVehicleSelector,
                              ScopeTemplates.DEFAULT_SCOPE),
            ComponentSettings(QUESTS_ALIASES.VEHICLE_SELECTOR_CAROUSEL_ALIAS, RegularVehicleSelectorCarousel,
                              ScopeTemplates.DEFAULT_SCOPE),
            GroupedViewSettings(QUESTS_ALIASES.MISSIONS_FILTER_POPOVER_ALIAS, MissionsFilterPopoverView,
                                'missionsFilterPopoverView.swf', WindowLayer.WINDOW,
                                QUESTS_ALIASES.MISSIONS_FILTER_POPOVER_ALIAS,
                                QUESTS_ALIASES.MISSIONS_FILTER_POPOVER_ALIAS, ScopeTemplates.DEFAULT_SCOPE),
            GroupedViewSettings(QUESTS_ALIASES.MISSIONS_TOKEN_POPOVER_ALIAS, MissionsTokenPopover,
                                'missionsTokenPopover.swf', WindowLayer.WINDOW,
                                QUESTS_ALIASES.MISSIONS_TOKEN_POPOVER_ALIAS,
                                QUESTS_ALIASES.MISSIONS_TOKEN_POPOVER_ALIAS, ScopeTemplates.DEFAULT_SCOPE),
            GroupedViewSettings(VIEW_ALIAS.VEHICLES_FILTER_POPOVER, VehiclesFilterPopover,
                                'vehiclesFiltersPopoverView.swf', WindowLayer.WINDOW,
                                VIEW_ALIAS.VEHICLES_FILTER_POPOVER, VIEW_ALIAS.VEHICLES_FILTER_POPOVER,
                                ScopeTemplates.DEFAULT_SCOPE))
