...
TABS_DATA_ORDERED = [
    ...
    TabData(QUESTS_ALIASES.MISSIONS_GROUPED_VIEW_PY_ALIAS, QUESTS_ALIASES.MISSIONS_GROUPED_VIEW_LINKAGE,
            ...
            None),
    TabData(QUESTS_ALIASES.MAPBOX_VIEW_PY_ALIAS, QUESTS_ALIASES.MAPBOX_VIEW_LINKAGE, QUESTS.MISSIONS_TAB_MAPBOX_HEADER,
            QUESTS.MISSIONS_TAB_MAPBOX_HEADER, backport.text(R.strings.mapbox.mapboxTab()), None),
