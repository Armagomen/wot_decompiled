...
_TOKEN_SLOTS = {PM_BRANCH.REGULAR: (
                     (
                      VEHICLE_CLASS_NAME.AT_SPG, RES_ICONS.MAPS_ICONS_QUESTS_BONUSES_BIG_COMPLETIONTOKENS_1_4),
                     (
   ...
   PM_BRANCH.PERSONAL_MISSION_2: (
                                (
                                 Alliances.FRANCE, RES_ICONS.MAPS_ICONS_QUESTS_BONUSES_BIG_COMPLETIONTOKENS_5_4),
                                (
...
class PersonalMissionsAwardsView(LobbySubView, PersonalMissionsAwardsViewMeta, PersonalMissionsNavigation):
    ...
    def __getVehiclePartSlot(self, tokenType, iconSource, isCollected, canUnlock, unlockCost):
        ...
        slotData = {'tokenType': tokenType, 
           ...
           'unlockBtnLabel': makeHtmlString('html_templates:lobby/quests/personalMission', 'unlockBtnLabel', {'branch': self.getBranch(), 'value': unlockCost}), 
           'tooltipData': {'isSpecial': True, 
                           'specialAlias': TOOLTIPS_CONSTANTS.PERSONAL_MISSIONS_TANKMODULE, 
                           'specialArgs': [
                                         self.getOperationID(), tokenType]}}
        return slotData
