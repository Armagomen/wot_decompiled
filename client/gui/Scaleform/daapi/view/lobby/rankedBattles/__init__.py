...
def getViewSettings():
    ...
    return (
    ViewSettings(RANKEDBATTLES_ALIASES.RANKED_BATTLES_PAGE_ALIAS, RankedMainSeasonOnPage, 'rankedBattlesPage.swf',
                 WindowLayer.SUB_VIEW, RANKEDBATTLES_ALIASES.RANKED_BATTLES_PAGE_ALIAS, ScopeTemplates.LOBBY_SUB_SCOPE),
    ViewSettings(RANKEDBATTLES_ALIASES.RANKED_BATTLES_PAGE_SEASON_OFF_ALIAS, RankedMainSeasonOffPage,
                 'rankedBattlesPage.swf', WindowLayer.SUB_VIEW,
                 RANKEDBATTLES_ALIASES.RANKED_BATTLES_PAGE_SEASON_OFF_ALIAS, ScopeTemplates.LOBBY_SUB_SCOPE),
    ViewSettings(RANKEDBATTLES_ALIASES.RANKED_BATTLES_INTRO_ALIAS, RankedBattlesIntro, 'rankedBattlesIntro.swf',
                 WindowLayer.SUB_VIEW, RANKEDBATTLES_ALIASES.RANKED_BATTLES_INTRO_ALIAS,
                 ScopeTemplates.LOBBY_SUB_SCOPE),
    ComponentSettings(RANKEDBATTLES_ALIASES.RANKED_BATTLES_REWARDS_UI, RankedRewardsSeasonOnView,
                      ScopeTemplates.DEFAULT_SCOPE),
    ComponentSettings(RANKEDBATTLES_ALIASES.RANKED_BATTLES_REWARDS_SEASON_OFF_ALIAS, RankedRewardsSeasonOffView,
                      ScopeTemplates.DEFAULT_SCOPE),
    ComponentSettings(RANKEDBATTLES_ALIASES.RANKED_BATTLES_REWARDS_RANKS_UI, RankedBattlesRewardsRanksView,
                      ScopeTemplates.DEFAULT_SCOPE),
    ComponentSettings(RANKEDBATTLES_ALIASES.RANKED_BATTLES_REWARDS_LEAGUES_UI, RankedBattlesRewardsLeaguesView,
                      ScopeTemplates.DEFAULT_SCOPE),
    ComponentSettings(RANKEDBATTLES_ALIASES.RANKED_BATTLES_WEB_SEASON_GAP_ALIAS, RankedSeasonGapPage,
                      ScopeTemplates.DEFAULT_SCOPE),
    ComponentSettings(RANKEDBATTLES_ALIASES.RANKED_BATTLES_SHOP_ALIAS, RankedShopPage, ScopeTemplates.DEFAULT_SCOPE),
    ComponentSettings(RANKEDBATTLES_ALIASES.RANKED_BATTLES_RAITING_ALIAS, RankedRatingPage,
                      ScopeTemplates.DEFAULT_SCOPE),
    ComponentSettings(RANKEDBATTLES_ALIASES.RANKED_BATTLES_YEAR_RAITING_ALIAS, RankedYearRatingPage,
                      ScopeTemplates.DEFAULT_SCOPE),
    ComponentSettings(RANKEDBATTLES_ALIASES.RANKED_BATTLES_INFO_ALIAS, RankedBattlesInfoPage,
                      ScopeTemplates.DEFAULT_SCOPE),
    ComponentSettings(RANKEDBATTLES_ALIASES.RANKED_BATTLES_REWARDS_YEAR_UI, RankedBattlesRewardsYearView,
                      ScopeTemplates.DEFAULT_SCOPE),
    ComponentSettings(RANKEDBATTLES_ALIASES.RANKED_BATTLES_DIVISIONS_VIEW_UI, RankedBattlesDivisionsView,
                      ScopeTemplates.DEFAULT_SCOPE),
    ComponentSettings(RANKEDBATTLES_ALIASES.RANKED_BATTLES_DIVISIONS_PROGRESS_UI, RankedBattlesProgress,
                      ScopeTemplates.DEFAULT_SCOPE),
    ComponentSettings(RANKEDBATTLES_ALIASES.RANKED_BATTLES_DIVISIONS_QUALIFICATION_UI, RankedBattlesQualification,
                      ScopeTemplates.DEFAULT_SCOPE),
    ComponentSettings(RANKEDBATTLES_ALIASES.RANKED_BATTLES_LEAGUES_VIEW_UI, RankedBattlesLeaguesView,
                      ScopeTemplates.DEFAULT_SCOPE),
    ComponentSettings(RANKEDBATTLES_ALIASES.RANKED_BATTLES_SEASON_GAP_VIEW_UI, RankedBattlesSeasonGapView,
                      ScopeTemplates.DEFAULT_SCOPE),
    ViewSettings(RANKEDBATTLES_ALIASES.RANKED_BATTLES_UNREACHABLE_VIEW_ALIAS, RankedBattlesUnreachableView,
    ...
    ViewSettings(RANKEDBATTLES_ALIASES.RANKED_BATTLES_SEASON_COMPLETE, RankedBattlesSeasonCompleteView,
                 ...
                 RANKEDBATTLES_ALIASES.RANKED_BATTLES_SEASON_COMPLETE, ScopeTemplates.LOBBY_TOP_SUB_SCOPE, True),
    ComponentSettings(RANKEDBATTLES_ALIASES.RANKED_BATTLE_RESULTS_WIDGET, RankedBattleResultsWidget,
                      ScopeTemplates.DEFAULT_SCOPE),
    ComponentSettings(RANKEDBATTLES_ALIASES.ENTRY_POINT, RankedBattlesEntryPoint, ScopeTemplates.DEFAULT_SCOPE),
    ViewSettings(RANKEDBATTLES_ALIASES.RANKED_BATTLE_PRIME_TIME, RankedBattlesPrimeTimeView,
                 HANGAR_ALIASES.RANKED_PRIME_TIME, WindowLayer.SUB_VIEW, RANKEDBATTLES_ALIASES.RANKED_BATTLE_PRIME_TIME,
                 ScopeTemplates.LOBBY_SUB_SCOPE, True),
    ViewSettings(RANKEDBATTLES_ALIASES.RANKED_BATTLE_SHOP_LANDING, RankedShopLandingView, 'browserScreen.swf',
                 WindowLayer.SUB_VIEW, RANKEDBATTLES_ALIASES.RANKED_BATTLE_SHOP_LANDING, ScopeTemplates.LOBBY_SUB_SCOPE,
                 True),
    ViewSettings(RANKEDBATTLES_ALIASES.RANKED_BATTLE_YEAR_RATING_LANDING, RankedYearLBLandingView, 'browserScreen.swf',
                 WindowLayer.SUB_VIEW, RANKEDBATTLES_ALIASES.RANKED_BATTLE_YEAR_RATING_LANDING,
                 ScopeTemplates.LOBBY_SUB_SCOPE, True),
    ViewSettings(RANKEDBATTLES_ALIASES.RANKED_WEB_OVERLAY, RankedWebOverlay, 'browserScreen.swf',
                 WindowLayer.FULLSCREEN_WINDOW, RANKEDBATTLES_ALIASES.RANKED_WEB_OVERLAY,
                 ScopeTemplates.LOBBY_SUB_SCOPE))
