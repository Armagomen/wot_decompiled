...
def getViewSettings():
    ...
    from gui.Scaleform.daapi.view.battle.winback import full_stats
    ...
    return (
     ViewSettings(VIEW_ALIAS.WINBACK_BATTLE_PAGE, ClassicPage, 'battlePage.swf', WindowLayer.VIEW, None, ScopeTemplates.DEFAULT_SCOPE),
     ...
     ComponentSettings(BATTLE_VIEW_ALIASES.FULL_STATS, full_stats.WinbackFullStatsComponent, ScopeTemplates.DEFAULT_SCOPE),
...
def getBusinessHandlers():
    return (
     BattlePageBusinessHandler(VIEW_ALIAS.WINBACK_BATTLE_PAGE),)