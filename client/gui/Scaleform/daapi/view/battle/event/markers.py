...
class World2DLocationMarkerComponent(World2DMarkerComponent):
    ...
    def _setupMarker(self, gui):
        ...
        gui.setMarkerRenderInfo(self._componentID, minScale, self._BOUNDS, self._INNER_BOUNDS, self._CULL_DISTANCE,
                                self._BOUNDS_MIN_SCALE)
        gui.setMarkerLocationOffset(self._componentID, self._MIN_Y_OFFSET, self._MAX_Y_OFFSET,
                                    self._DISTANCE_FOR_MIN_Y_OFFSET, self._MAX_Y_BOOST, self._BOOST_START)
