...
class EventVehicleMarkerPlugin(RespawnableVehicleMarkerPlugin):
    ...
    def _setVehicleInfo(self, marker, vInfo, guiProps, nameParts):
        ...
        self._invokeMarker(markerID, 'setVehicleInfo', classTag, vType.iconPath, nameParts.vehicleName, vType.level,
                           nameParts.playerFullName, nameParts.playerName, nameParts.clanAbbrev, nameParts.regionCode,
                           vType.maxHealth, guiPropsName, hunting, squadIndex,
