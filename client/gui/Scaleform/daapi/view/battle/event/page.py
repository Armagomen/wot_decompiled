...
from gui.battle_control.controllers.spawn_ctrl import ISpawnListener, SpawnType
...
EVENT_CONFIG = ComponentsConfig(config=((BATTLE_CTRL_ID.BATTLE_HINTS, (
BATTLE_VIEW_ALIASES.BATTLE_HINT, BATTLE_VIEW_ALIASES.BATTLE_TIMER, _SoundPlayerAliases.BATTLE_HINT_SOUND)),
                                        ...
                                        (BATTLE_CTRL_ID.SPAWN_CTRL, (BATTLE_VIEW_ALIASES.EVENT_HUNTER_RESPAWN,
                                                                     BATTLE_VIEW_ALIASES.EVENT_BOSS_TELEPORT,
                                                                     _SoundPlayerAliases.RESPAWN_SOUND_PLAYER)),
                                        (BATTLE_CTRL_ID.BATTLE_FIELD_CTRL,
                                         (BATTLE_VIEW_ALIASES.PLAYERS_PANEL_EVENT, DynamicAliases.DRONE_MUSIC_PLAYER)),
                                        ...
                                        (BATTLE_CTRL_ID.GAME_MESSAGES_PANEL,
                                         (BATTLE_VIEW_ALIASES.GAME_MESSAGES_PANEL,))), viewsConfig=(
...
_HUNTER_VIEW_COMPONENTS = (BATTLE_VIEW_ALIASES.EVENT_REINFORCEMENT_PANEL, BATTLE_VIEW_ALIASES.BATTLE_MESSENGER)
...
class EventBattlePage(ClassicPage, ISpawnListener):
    ...
    def showSpawnPoints(self):
        ...
        visibleComponents = {self._spawnViewAlias, BATTLE_VIEW_ALIASES.MINIMAP} | self._spawnVisibleComponents
    ...
    def _spawnVisibleComponents(self):
        return {BATTLE_VIEW_ALIASES.CONSUMABLES_PANEL,
                BATTLE_VIEW_ALIASES.BATTLE_TIMER} if self._spawnType == SpawnType.TELEPORT else {
            BATTLE_VIEW_ALIASES.PLAYERS_PANEL_EVENT, BATTLE_VIEW_ALIASES.BATTLE_TIMER,
    ...
    def _populate(self):
        ...
        self.addListener(events.RadialMenuEvent.RADIAL_MENU_ACTION, self.__handleRadialAction,
    ...
    def _dispose(self):
        ...
        self.removeListener(events.RadialMenuEvent.RADIAL_MENU_ACTION, self.__handleRadialAction,
                            scope=EVENT_BUS_SCOPE.BATTLE)
    ...
    def _onBattleLoadingFinish(self):
        ...
        if self.__isBoss():
            self._blToggling -= {BATTLE_VIEW_ALIASES.BATTLE_MESSENGER, BATTLE_VIEW_ALIASES.EVENT_REINFORCEMENT_PANEL}
