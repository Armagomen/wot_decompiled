...
class BaseAreaMarkerPlugin(MarkerPlugin):
    ...
    def setMarkerRenderInfo(self, uniqueID, minScale, offset, innerOffset, cullDistance, boundsMinScale):
        if uniqueID in self.__markers:
            self._setMarkerRenderInfo(self.__markers[uniqueID], minScale, offset, innerOffset, cullDistance,
                                      boundsMinScale)

    def setMarkerLocationOffset(self, uniqueID, minYOffset, maxYOffset, distanceForMinYOffset, maxBoost, boostStart):
        if uniqueID in self.__markers:
            self._setMarkerLocationOffset(self.__markers[uniqueID], minYOffset, maxYOffset, distanceForMinYOffset,
                                          maxBoost, boostStart)
    ...
    def setupMarker(self, uniqueID, shape, minDistance, maxDistance, distance, distanceFieldColor):
        self.invokeMarker(uniqueID, 'init', shape, minDistance, maxDistance, distance,
                          backport.text(R.strings.ingame_gui.marker.meters()), distanceFieldColor)
