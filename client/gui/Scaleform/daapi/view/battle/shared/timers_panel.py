...
_TIMERS_PRIORITY = {(_TIMER_STATES.STUN, _TIMER_STATES.WARNING_VIEW): 1,
                    ...
                    (_TIMER_STATES.HALF_OVERTURNED, _TIMER_STATES.CRITICAL_VIEW): 1,
                    ...
                    (_TIMER_STATES.HALF_OVERTURNED, _TIMER_STATES.WARNING_VIEW): 4,
...
class TimersPanel(TimersPanelMeta, MethodsRules):
    ...
    def _generateSecondaryTimersData(self):
        ...
        data = [self._getNotificationTimerData(_TIMER_STATES.STUN, BATTLE_NOTIFICATIONS_TIMER_LINKAGES.STUN_ICON, link, BATTLE_NOTIFICATIONS_TIMER_COLORS.ORANGE, True, False, INGAME_GUI.STUN_INDICATOR),
         self._getNotificationTimerData(_TIMER_STATES.CAPTURE_BLOCK, BATTLE_NOTIFICATIONS_TIMER_LINKAGES.BLOCKED_ICON, link, BATTLE_NOTIFICATIONS_TIMER_COLORS.ORANGE, False, False, EPIC_BATTLE.PROGRESS_TIMERS_BLOCKED),
         self._getNotificationTimerData(_TIMER_STATES.SMOKE, BATTLE_NOTIFICATIONS_TIMER_LINKAGES.SMOKE_ICON, link, BATTLE_NOTIFICATIONS_TIMER_COLORS.GREEN, False, False, EPIC_BATTLE.SMOKE_IN_SMOKE),
         self._getNotificationTimerData(_TIMER_STATES.INSPIRE, BATTLE_NOTIFICATIONS_TIMER_LINKAGES.INSPIRE_ICON, link, BATTLE_NOTIFICATIONS_TIMER_COLORS.GREEN, False, True, EPIC_BATTLE.INSPIRE_INSPIRED),
         self._getNotificationTimerData(_TIMER_STATES.INSPIRE_CD, BATTLE_NOTIFICATIONS_TIMER_LINKAGES.INSPIRE_ICON, link, BATTLE_NOTIFICATIONS_TIMER_COLORS.GREEN, False, False, EPIC_BATTLE.INSPIRE_INSPIRED)]
        return data
