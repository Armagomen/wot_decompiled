...
from account_helpers.AccountSettings import TRAJECTORY_VIEW_HINT_SECTION, PRE_BATTLE_HINT_SECTION, \
    ...
    PRE_BATTLE_ROLE_HINT_SECTION, COMMANDER_CAM_HINT_SECTION, FUN_RANDOM_HINT_SECTION, \
    ROCKET_ACCELERATION_MODE_HINT_SECTION, RESERVES_HINT_SECTION
