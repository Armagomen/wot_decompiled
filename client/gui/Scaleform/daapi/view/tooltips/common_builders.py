...
def getTooltipBuilders():
    return (
     DataBuilder(TOOLTIPS_CONSTANTS.EFFICIENCY_PARAM, TOOLTIPS_CONSTANTS.FINAL_STSTS_UI, common.EfficiencyTooltipData(contexts.FinalStatisticContext())),
     ...
     HeaderMoneyAndXpBuilder(CURRENCIES_CONSTANTS.GOLD, TOOLTIPS_CONSTANTS.GOLD_INFO_SIMPLE, TOOLTIPS_CONSTANTS.BLOCKS_DEFAULT_UI, True),
     HeaderMoneyAndXpBuilder(CURRENCIES_CONSTANTS.CREDITS, TOOLTIPS_CONSTANTS.CREDITS_INFO_SIMPLE, TOOLTIPS_CONSTANTS.BLOCKS_DEFAULT_UI, True),
     HeaderMoneyAndXpBuilder(CURRENCIES_CONSTANTS.CRYSTAL, TOOLTIPS_CONSTANTS.CRYSTAL_INFO_SIMPLE, TOOLTIPS_CONSTANTS.BLOCKS_DEFAULT_UI, True),
     HeaderMoneyAndXpBuilder(CURRENCIES_CONSTANTS.FREE_XP, TOOLTIPS_CONSTANTS.FREEXP_INFO_SIMPLE, TOOLTIPS_CONSTANTS.BLOCKS_DEFAULT_UI, True),
     ...
     TooltipWindowBuilder(TOOLTIPS_CONSTANTS.EXCHANGE_RATE_DISCOUNT_INFO, None, DiscountInfoTooltipContentWindowData(contexts.ToolTipContext(None))),
     TooltipWindowBuilder(TOOLTIPS_CONSTANTS.EXCHANGE_RATE_LIMITED_DISCOUNT_INFO, None, LimitedDiscountInfoTooltipContentWindowData(contexts.ToolTipContext(None))))
