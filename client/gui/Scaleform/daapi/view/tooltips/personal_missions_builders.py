...
def getTooltipBuilders():
    return (
     ...
     TooltipWindowBuilder(TOOLTIPS_CONSTANTS.PERSONAL_MISSIONS_POINTS, None, common.ParamsTooltipContent(contexts.PersonalMissionsPointsTooltipContext(None), TOOLTIPS_CONSTANTS.PERSONAL_MISSIONS_POINTS)),
     TooltipWindowBuilder(TOOLTIPS_CONSTANTS.PERSONAL_MISSION_OPERATION_DISABLED, None, common.ParamsTooltipContent(contexts.PersonalMissionOperationDisabledTooltipContext(None), TOOLTIPS_CONSTANTS.PERSONAL_MISSION_OPERATION_DISABLED)))