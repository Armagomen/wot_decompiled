...
'gui.Scaleform.daapi.view.lobby.tank_setup', 'battle_royale.gui.Scaleform.daapi.view.lobby',
...
__LOBBY_TOOLTIPS_BUILDERS_PATHS = [('gui.Scaleform.daapi.view.tooltips.achievement_builders', _TOOLTIPS.ACHIEVEMENTS_SET),
                                   ...
                                   ('gui.Scaleform.daapi.view.tooltips.mapbox_lobby_builders',
                                    _TOOLTIPS.MAPBOX_LOBBY_SET),
                                   ...
                                   ('gui.Scaleform.daapi.view.tooltips.resource_well_builders',
                                    _TOOLTIPS.RESOURCE_WELL_SET)]
