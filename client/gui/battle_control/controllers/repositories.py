...
from gui.battle_control.controllers import arena_border_ctrl, arena_load_ctrl, battle_field_ctrl, avatar_stats_ctrl, \
    ...
    team_health_bar_ctrl, battle_notifier_ctrl, prebattle_setups_ctrl, arena_info_ctrl, battle_hints_ctrl, \
    players_panel_ctrl, boss_info_ctrl
from gui.battle_control.controllers.appearance_cache_ctrls.battle_royale_appearance_cache_ctrl import \
    BattleRoyaleAppearanceCacheController
...
class SharedControllersRepository(_ControllersRepository):
    ...
    def create(cls, setup):
        ...
        repository.addController(korea_msgs_ctrl.createKoreaMessagesController())
...
class EventControllerRepository(_ControllersRepositoryByBonuses):
    ...
    def create(cls, setup):
        ...
        repository.addViewController(spawn_ctrl.WtSpawnController(), setup)
        repository.addViewController(battle_hints_ctrl.createBattleHintsController(), setup)
