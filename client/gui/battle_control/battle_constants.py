...
class VEHICLE_VIEW_STATE(object):
    ...
    WT_BOMB_CAPTURE = 35184372088832L
    WT_BOMB_CARRY = 70368744177664L
    WT_BOMB_DEPLOY = 140737488355328L
    WT_BOMB_ABSORB = 281474976710656L
