...
_REGULAR_TABS_VO_META = base.ListMeta([
 {'label': i18n.makeString(MENU.FINALSTATISTIC_TABS_COMMONSTATS), 
    'linkage': 'CommonStats', 
    'viewId': 'CommonStats', 
    'showWndBg': False},
...
_COMMON_VO_META = base.DictMeta({'iconType': 'tank', 
   ...
   'playerFullNameStr': '', 
   'regionNameStr': '', 
   'playerVehicles': [], 'playerVehicleNames': [], 'overtime': {}, 'totalFortResourceStr': '', 
   'totalInfluenceStr': '', 
   'timeStats': [], 'clientArenaIdx': 0, 
   'uiVisibility': 0, 
...
CLANS_COMMON_VO_META = base.PropertyMeta((
 (
  'allies', common.ClanInfoBlock(field='allies'), 'allies'),
 (
  'enemies', common.ClanInfoBlock(field='enemies'), 'enemies')))
...
_PERSONAL_PLAYER_NAME_VO_META = base.PropertyMeta((
 ('playerFakeNameStr', '', 'fakeNameLabel'),
...
_KILLER_NAME_VO_META = base.PropertyMeta((
 ('killerFakeNameStr', '', 'fakeNameLabel'),
...
_PERSONAL_VO_META = base.DictMeta({'isPremium': False, 
   ...
   'isPremiumPlus': False, 
   'dynamicPremiumState': '', 
   'premiumInfo': {}, 'premiumBonus': {}, 'premiumEarnings': {}})
...
_DAMAGE_DETAILS_VO_META = base.PropertyMeta((
 ('damageTotalItems', 0, 'piercings'),
 ('damageDealtVals', None, 'damageDealtValues'),
 ('damageDealtNames', None, 'damageDealtNames')))
_DAMAGE_DETAILS_VO_META.bind(personal.DamageDetailsBlock)
_ARMOR_USING_DETAILS_VO_META = base.PropertyMeta((
 ('armorTotalItems', 0, 'usedArmorCount'),
 ('armorVals', None, 'armorValues'),
 ('armorNames', None, 'armorNames')))
...
_ASSIST_USING_DETAILS_VO_META = base.PropertyMeta((
 ...
 ('damageAssistedVals', None, 'damageAssistedValues'),
 ('damageAssistedNames', None, 'damageAssistedNames')))
_ASSIST_USING_DETAILS_VO_META.bind(personal.AssistDetailsBlock)
_STUN_DETAILS_VO_META = base.PropertyMeta((
 ('stunTotalItems', 0, 'stunNum'),
...
_EFFICIENCY_DETAILS_VO_META = base.PropertyMeta((
 ...
 (
  'vehicleName',
  i18n.makeString(INGAME_GUI.PLAYERS_PANEL_UNKNOWN_VEHICLE), 'vehicleName')))
...
_ACHIEVEMENTS_LIST_VO_META = base.DictMeta({'achievementsLeft': [], 'achievementsRight': []})
...
_PREMIUM_EARNINGS_VO_META = base.DictMeta({'xpTitleStrings': [], 'xpTitleTooltips': [], 'xpPremValues': [], 'xpNoPremValues': [], 'creditsPremValues': [], 'creditsNoPremValues': [], 'backgroundIcon': backport.image(R.images.gui.maps.icons.premacc.battleResult.premium())})
...
TEAMS_VO_META = base.DictMeta({'team1': [], 'team2': []})
