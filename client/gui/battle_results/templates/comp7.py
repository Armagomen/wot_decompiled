...
from gui.battle_results.templates.regular import _PERSONAL_VO_META, _COMMON_VO_META, REGULAR_PERSONAL_STATS_BLOCK, \
    REGULAR_COMMON_STATS_BLOCK, TEAMS_VO_META
...
COMP7_PERSONAL_STATS_BLOCK.addComponent(STATS_COMPONENT_NUMBER,
                                        comp7.PersonalVehiclesComp7StatsBlock(base.ListMeta(), 'statValues',
                                                                              _RECORD.PERSONAL))
COMP7_PERSONAL_STATS_BLOCK.addNextComponent(
    comp7.PrestigePointsBlock(_PRESTIGE_POINTS_VO_META, 'prestigePoints', _RECORD.PERSONAL))
...
COMP7_BATTLE_PASS_PROGRESS_STATS_BLOCK = progress.Comp7BattlePassProgressBlock(base.ListMeta(), 'battlePass',
                                                                               _RECORD.PERSONAL)
VEHICLE_STATS_BLOCK_VO_META = base.PropertyMeta((('shots', 0, 'shots'),
                                                 ...
                                                 ('teamHitsDamage', style.RedSlashedValuesBlock('teamHitsDamage'),
                                                  'teamHitsDamage'),
                                                 ('spotted', 0, 'spotted'),
