...
from gui.battle_results.br_helper import getDamageBlockDetails, getArmorUsingDetails, getStunBlockDetails, \
    getAssistBlockDetails, getCaptureBlockDetails, getDefenceBlockDetails, getCriticalDevicesBlock, \
    getDestroyedDevicesBlock, getDestroyedTankmenBlock, convertToDict
...
class DamageDetailsBlock(_DetailsBlock):
    ...
    def setRecord(self, result, reusable):
        ...
        if damageDealt > 0:
            self._isEmpty = False
            labels = (R.strings.battle_results.common.tooltip.damage.part1(),
                      R.strings.battle_results.common.tooltip.damage.part2())
...
class ArmorUsingDetailsBlock(_DetailsBlock):
    ...
    def setRecord(self, result, _):
        ...
        if noDamage > 0 or damageBlocked > 0:
            ...
            labels = (R.strings.battle_results.common.tooltip.armor.part1(),
                      R.strings.battle_results.common.tooltip.armor.part2(),
...
class AssistDetailsBlock(_DetailsBlock):
    ...
    def setRecord(self, result, reusable):
        ...
        if damageAssisted > 0:
            self._isEmpty = False
            self.damageAssistedValues, self.damageAssistedNames = getAssistBlockDetails(damageAssistedRadio,
                                                                                        damageAssistedTrack,
                                                                                        damageAssisted, (
                                                                                        R.strings.battle_results.common.tooltip.assist.part1(),
                                                                                        R.strings.battle_results.common.tooltip.assist.part2(),
...
class StunDetailsBlock(_DetailsBlock):
    ...
    def setRecord(self, result, _):
        ...
        if count > 0 or assisted > 0 or duration > 0:
            self._isEmpty = False
            self.stunValues, self.stunNames = getStunBlockDetails(assisted, count, duration, (
    ...
    def setRecord(self, result, reusable):
        ...
        if info is None:
            ...
            self.killsTooltip = self.__makeEfficiencyHeaderTooltip(
                EfficiencyItems[PersonalEfficiency.KILLS][EfficiencyKeys.TOTAL], value)
            ...
            self.damageDealtTooltip = self.__makeEfficiencyHeaderTooltip(
                EfficiencyItems[PersonalEfficiency.DAMAGE][EfficiencyKeys.TOTAL], value)
            ...
            self.criticalDamagesTooltip = self.__makeEfficiencyHeaderTooltip(
                EfficiencyItems[PersonalEfficiency.CRITS][EfficiencyKeys.TOTAL], value)
            ...
            self.damageBlockedTooltip = self.__makeEfficiencyHeaderTooltip(
                EfficiencyItems[PersonalEfficiency.ARMOR][EfficiencyKeys.TOTAL], value)
            ...
            self.damageAssistedTooltip = self.__makeEfficiencyHeaderTooltip(
                EfficiencyItems[PersonalEfficiency.ASSIST][EfficiencyKeys.TOTAL], value)
            ...
            self.damageAssistedStunTooltip = self.__makeEfficiencyHeaderTooltip(
                EfficiencyItems[PersonalEfficiency.STUN][EfficiencyKeys.TOTAL], value)
            value = info.spotted
            self.spotted = numbers.formatInt(value, _UNDEFINED_EFFICIENCY_VALUE)
            self.spottedTooltip = self.__makeEfficiencyHeaderTooltip(
                EfficiencyItems[PersonalEfficiency.SPOTTED][EfficiencyKeys.TOTAL], value)
