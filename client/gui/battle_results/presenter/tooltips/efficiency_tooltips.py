...
from gui.battle_results.br_helper import getArenaBonusType, getEnemies, getDamageBlockDetails, getStunBlockDetails, \
    getAssistBlockDetails, getCaptureBlockDetails, getDefenceBlockDetails, getCriticalDevicesBlock, \
    getDestroyedDevicesBlock, getArmorUsingDetails, BattleResultData, convertToDict
...
class EfficiencyGetter(object):
    ...
    def _getArmorBaseValues(cls, playerResult, battleResults):
        ...
        if noDamage > 0 or damageBlocked > 0:
            ...
            values, descriptions = getArmorUsingDetails(cls._getRickochets(playerResult, battleResults), noDamage,
                                                        damageBlocked, labels)
    ...
    def _getAssistBaseValues(cls, playerResult):
        ...
        if damageAssisted > 0:
            ...
            damageAssistedValues, damageAssistedNames = getAssistBlockDetails(damageAssistedRadio, damageAssistedTrack,
                                                                              damageAssisted, labels)
    ...
    def _getStunLabels(cls):
        return (
        R.strings.battle_results.common.tooltip.stun.part1(), R.strings.battle_results.common.tooltip.stun.part2(),
        R.strings.battle_results.common.tooltip.stun.part3())

    @classmethod
    def _getAssistLabels(cls):
        return (
        R.strings.battle_results.common.tooltip.assist.part1(), R.strings.battle_results.common.tooltip.assist.part2(),
        R.strings.battle_results.common.tooltip.assist.total())

    @classmethod
    def _getArmorLabels(cls):
        return (
        R.strings.battle_results.common.tooltip.armor.part1(), R.strings.battle_results.common.tooltip.armor.part2(),
        R.strings.battle_results.common.tooltip.armor.part3())

    @classmethod
    def _getDamageLabels(cls):
        return (
        R.strings.battle_results.common.tooltip.damage.part1(), R.strings.battle_results.common.tooltip.damage.part2())
...
class TotalEfficiencyGetter(EfficiencyGetter):
    ...
    def _processKilled(self, playerResult, battleResults=None):
        reusable, result = battleResults
        allReasons = Counter([enemy.deathReason for enemy in getEnemies(reusable, result) if
                              enemy.targetKills and enemy.deathReason >= 0])
    ...
    def _getStunLabels(cls):
        return (
        R.strings.postbattle_screen.tooltip.stun.totalDamage(), R.strings.postbattle_screen.tooltip.stun.totalCount(),
        R.strings.postbattle_screen.tooltip.stun.totalTime())

    @classmethod
    def _getAssistLabels(cls):
        return (R.strings.postbattle_screen.tooltip.assist.damageAssistedRadio(),
                R.strings.postbattle_screen.tooltip.assist.damageAssistedTrack(),
                R.strings.postbattle_screen.tooltip.assist.totalDamageAssisted())

    @classmethod
    def _getArmorLabels(cls):
        return (R.strings.postbattle_screen.tooltip.armor.totalRicochets(),
                R.strings.postbattle_screen.tooltip.armor.totalNotPierced(),
                R.strings.postbattle_screen.tooltip.armor.totalBlockedDamage())

    @classmethod
    def _getDamageLabels(cls):
        return (R.strings.postbattle_screen.tooltip.damage.totalDamage(),
                R.strings.postbattle_screen.tooltip.damage.totalPierced())
