...
from gui.battle_results.presenter.common import getTotalXPToShow, getTotalCreditsToShow, getXpRecords, \
    getCreditsRecords, getCrystalsRecords, setPremiumBonuses
...
def setPersonalData(model, cachedSettings, reusable, result):
    ...
    model.rewards.setIsPremiumBought(reusable.economics.isActivePremiumPlus())
