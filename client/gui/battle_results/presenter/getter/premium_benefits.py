...
PremiumBenefits = namedtuple('premiumBenefits', (
'xpBonus', 'creditsBonus', 'tmenXPBonus', 'additionalBonus', 'piggyBank', 'premQuests', 'preferredMaps', 'squadBonus'))
...
def getPremiumBenefits():
    return PremiumBenefits(xpBonus=PremiumBattleBonusField(stringID=_PREMIUM_BENEFIT_STRINGS.xpBonus(),
                                                           types=(PremiumBenefitModel.PERCENT_VALUE,), substitutionIDs=(
        _PremiumBenefitSubstitutionIDs.MULTIPLIER_PERCENT,), settingsGetter='getPremiumPlusXPBonus'),
                           creditsBonus=PremiumBattleBonusField(stringID=_PREMIUM_BENEFIT_STRINGS.creditsBonus(),
                                                                types=(PremiumBenefitModel.PERCENT_VALUE,),
                                                                substitutionIDs=(
                                                                _PremiumBenefitSubstitutionIDs.MULTIPLIER_PERCENT,),
                                                                settingsGetter='getPremiumPlusCreditsBonus'),
                           tmenXPBonus=PremiumBattleBonusField(stringID=_PREMIUM_BENEFIT_STRINGS.tmenXpBonus(),
                                                               types=(PremiumBenefitModel.PERCENT_VALUE,),
                                                               substitutionIDs=(
                                                               _PremiumBenefitSubstitutionIDs.MULTIPLIER_PERCENT,),
                                                               settingsGetter='getPremiumPlusTmenXPBonus'),
                           additionalBonus=PremiumBenefitField(stringID=_PREMIUM_BENEFIT_STRINGS.additionalBonus(),
                                                               types=(PremiumBenefitModel.NUMBER_VALUE,
                                                                      PremiumBenefitModel.NUMBER_VALUE),
                                                               substitutionIDs=(
                                                               _PremiumBenefitSubstitutionIDs.MULTIPLIER,
                                                               _PremiumBenefitSubstitutionIDs.COUNT),
                                                               settingsGetter='getAdditionalBonusConfig',
                                                               settingNames=('bonusFactor', 'applyCount')),
                           piggyBank=PremiumBenefitField(stringID=_PREMIUM_BENEFIT_STRINGS.piggyBank(),
                                                         types=(PremiumBenefitModel.PERCENT_VALUE,), substitutionIDs=(
                               _PremiumBenefitSubstitutionIDs.MULTIPLIER_PERCENT,), settingsGetter='getPiggyBankConfig',
                                                         settingNames=('multiplier',)),
                           premQuests=PremiumQuestsField(stringID=_PREMIUM_BENEFIT_STRINGS.premQuests(),
                                                         types=(PremiumBenefitModel.NUMBER_VALUE,),
                                                         substitutionIDs=(_PremiumBenefitSubstitutionIDs.COUNT,),
                                                         settingsGetter='getPremQuestsConfig'),
                           preferredMaps=PremiumBenefitField(stringID=_PREMIUM_BENEFIT_STRINGS.preferredMaps(),
                                                             types=(PremiumBenefitModel.NUMBER_VALUE,),
                                                             substitutionIDs=(_PremiumBenefitSubstitutionIDs.COUNT,),
                                                             settingsGetter='getPreferredMapsConfig',
                                                             settingNames=('premiumSlots',), isAlwaysEnabled=True),
                           squadBonus=SquadBonusField(stringID=_PREMIUM_BENEFIT_STRINGS.squadBonus(),
                                                      types=(PremiumBenefitModel.PERCENT_VALUE,), substitutionIDs=(
                               _PremiumBenefitSubstitutionIDs.MULTIPLIER_PERCENT,), settingsGetter='squadPremiumBonus'))
