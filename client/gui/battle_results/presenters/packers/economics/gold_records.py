...
GOLD_PIGGY_BANK = CurrencyRecord(recordNames=(), subtractRecords=(), baseAccountValueExtractor=getGoldPiggyBank, premiumAccountValueExtractor=getGoldPiggyBank, detailsValuesExtractors=(
 isPiggyBankGoldAvailable,), capsToBeChecked=None, paramName=CurrencyRecordsItemModel.GOLD_PIGGY_BANK, label=_STR_PATH.piggyBankInfo, modifiers=(
...
TOTAL_GOLD = CurrencyRecord(recordNames=('gold', ), subtractRecords=('autoLoadGold',
                                                                     'autoEquipGold'), baseAccountValueExtractor=getTotalGoldValue, premiumAccountValueExtractor=getTotalGoldValue, detailsValuesExtractors=(), capsToBeChecked=None, paramName=CurrencyRecordsItemModel.TOTAL_GOLD, label=_STR_PATH.title.total, modifiers=(), showZeroValue=True, currencyType=CurrenciesConstants.GOLD)