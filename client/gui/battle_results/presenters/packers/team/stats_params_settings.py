...
REGULAR_PARAMETERS = {RegularParamType.SHOTS: _Parameter(path=_STR_PATH.shots, stringId='shots', fields=('shots', ), valueType=ValueType.INTEGER, conditions=None, extractor=getStatsParamValue, details=(
   ...
   RegularParamType.TEAMHITSDAMAGE: _Parameter(path=_STR_PATH.teamHitsDamage, stringId='teamHitsDamage', fields=('tkills',
                                                                             'tdamageDealt'), valueType=ValueType.INTEGER, conditions=None, extractor=getStatsParamValue, details=()), 
   ...
   RegularParamType.DAMAGEDKILLED: _Parameter(path=_STR_PATH.damagedKilled, stringId='damagedKilled', fields=('damaged',
                                                                           'kills'), valueType=ValueType.INTEGER, conditions=None, extractor=getStatsParamValue, details=()), 
   RegularParamType.DAMAGEASSISTED: _Parameter(path=_STR_PATH.damageAssisted, stringId='damageAssisted', fields=('damageAssisted', ), valueType=ValueType.INTEGER, conditions=(
                                   isNotPersonalBattleResult,), extractor=getStatsParamValue, details=()), 
   RegularParamType.DAMAGEASSISTEDSELF: _Parameter(path=_STR_PATH.damageAssistedSelf, stringId='damageAssistedSelf', fields=('damageAssisted', ), valueType=ValueType.INTEGER, conditions=(
                                       isPersonalBattleResult,), extractor=getStatsParamValue, details=()), 
   RegularParamType.STUNDURATION: _Parameter(path=_STR_PATH.stunDuration, stringId='stunDuration', fields=('stunDuration', ), valueType=ValueType.FLOAT, conditions=(
                                 hasStunEfficiency,), extractor=getStatsParamValue, details=()), 
   RegularParamType.DAMAGEASSISTEDSTUN: _Parameter(path=_STR_PATH.damageAssistedStun, stringId='damageAssistedStun', fields=('damageAssistedStun', ), valueType=ValueType.INTEGER, conditions=(
                                       hasStunEfficiency, isNotPersonalBattleResult), extractor=getStatsParamValue, details=()), 
   RegularParamType.DAMAGEASSISTEDSTUNSELF: _Parameter(path=_STR_PATH.damageAssistedStunSelf, stringId='damageAssistedStunSelf', fields=('damageAssistedStun', ), valueType=ValueType.INTEGER, conditions=(
                                           hasStunEfficiency, isPersonalBattleResult), extractor=getStatsParamValue, details=()), 
   RegularParamType.STUNNUM: _Parameter(path=_STR_PATH.stunNum, stringId='stunNum', fields=('stunNum', ), valueType=ValueType.INTEGER, conditions=(
                            hasStunEfficiency,), extractor=getStatsParamValue, details=()), 
   RegularParamType.CAPTUREPOINTSVAL: _Parameter(path=_STR_PATH.capturePointsVal, stringId='capturePointsVal', fields=('capturePoints',
                                                                                 'droppedCapturePoints'), valueType=ValueType.INTEGER, conditions=None, extractor=getStatsParamValue, details=()), 
