...
class GoodiesBonusUIPacker(BaseBonusUIPacker):
    ...
    def _getBoostersToolTip(cls, tooltipData, booster):
        tooltipData.append(TooltipData(tooltip=None, isSpecial=True, specialAlias=TOOLTIPS_CONSTANTS.SHOP_BOOSTER,
...
class VehiclesBonusUIPacker(BaseBonusUIPacker):
    ...
    def _packTooltip(cls, bonus, vehicle, vehInfo):
        return TooltipData(tooltip=None, isSpecial=True, specialAlias=cls._getTooltipAlias(),
                           specialArgs=cls._getTooltipArgs(bonus, vehicle, vehInfo))
