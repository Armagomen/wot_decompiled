...
class WulfTooltipData(ToolTipData):
    ...
    def getDisplayableData(self, *args, **kwargs):
        ...
        return WindowImpl(wndFlags=WindowFlags.WINDOW, content=self.getTooltipContent(*args, **kwargs), parent=parent,
                          areaID=R.areas.specific(), layer=WindowLayer.TOOLTIP)
