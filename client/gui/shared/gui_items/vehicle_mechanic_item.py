...
VEHICLE_MECHANICS_OVERRIDES = {VehicleMechanic.TURBOSHAFT_ENGINE: {
   ...
   VehicleMechanic.HYDRAULIC_WHEELED_CHASSIS: {
                                             VehicleMechanic.SIEGE_MODE}}
GUN_MECHANICS_OVERRIDES = {VehicleMechanic.AUTO_LOADER_GUN_BOOST: {
   ...
   VehicleMechanic.AUTO_SHOOT_GUN: {
                                  VehicleMechanic.MAGAZINE_GUN}}
CHASSIS_MECHANICS_OVERRIDES = {VehicleMechanic.HYDRAULIC_WHEELED_CHASSIS: {
