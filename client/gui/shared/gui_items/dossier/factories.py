...
import nations
from dossiers2.ui.achievements import ACHIEVEMENT_TYPE, getType as getAchieveType, ACHIEVEMENT_BLOCK as _AB, \
    WHITE_TIGER_RECORD, RARE_STORAGE_RECORD, HONORED_RANK_RECORD, MARK_OF_MASTERY, MARK_ON_GUN
...
_ACHIEVEMENTS_BY_NAME = {(_AB.TOTAL, 'warrior'): _CustomAchieveFactory.get(_as.regular_ext.WarriorAchievement),
                         ...
                         (_AB.SINGLE, 'medalBobLebwa'): _AchieveFactory.get(
                             _abstract_achievements.DeprecatedAchievement),
                         (_AB.SINGLE, 'medalBobYusha'): _AchieveFactory.get(
                             _abstract_achievements.DeprecatedAchievement),
                         (_AB.SINGLE, 'medalBobAmway921'): _AchieveFactory.get(
                             _abstract_achievements.DeprecatedAchievement),
                         (_AB.SINGLE, 'medalBobKorbenDallas'): _AchieveFactory.get(
                             _abstract_achievements.DeprecatedAchievement),
                         (_AB.SINGLE, 'medalBobMailand'): _AchieveFactory.get(
                             _abstract_achievements.DeprecatedAchievement),
                         (_AB.SINGLE, 'medalBobSkill4ltu'): _AchieveFactory.get(
                             _abstract_achievements.DeprecatedAchievement),
                         (_AB.SINGLE, 'medalBobDezgamez'): _AchieveFactory.get(
                             _abstract_achievements.DeprecatedAchievement),
                         (_AB.SINGLE, 'medalBobAwesomeEpicGuys'): _AchieveFactory.get(
                             _abstract_achievements.DeprecatedAchievement),
                         (_AB.SINGLE, 'medalBobTigers'): _AchieveFactory.get(
                             _abstract_achievements.DeprecatedAchievement),
                         (_AB.SINGLE, 'medalBobDragons'): _AchieveFactory.get(
                             _abstract_achievements.DeprecatedAchievement),
                         (_AB.SINGLE, 'bootcampMedal'): _AchieveFactory.get(_abstract_achievements.RegularAchievement),
                         (_AB.SINGLE, 'BattlePassCommonPr_1'): _AchieveFactory.get(
                             _abstract_achievements.DeprecatedAchievement),
                         (_AB.SINGLE, 'BattlePassCommonPr_2'): _AchieveFactory.get(
                             _abstract_achievements.DeprecatedAchievement),
                         (_AB.SINGLE, 'BattlePassCommonPr_3'): _AchieveFactory.get(
                             _abstract_achievements.DeprecatedAchievement),
                         (_AB.SINGLE, 'BattlePassCommonPr_4'): _AchieveFactory.get(
                             _abstract_achievements.DeprecatedAchievement),
                         (_AB.SINGLE, 'BattlePassCommonPr_5'): _AchieveFactory.get(
                             _abstract_achievements.DeprecatedAchievement),
                         (_AB.SINGLE, 'BattlePassCommonPr_6'): _AchieveFactory.get(
                             _abstract_achievements.DeprecatedAchievement),
                         (_AB.TOTAL, 'collectorVehicle'): _NationAchieveFactory.get(
                             _as.nation_specific.VehicleCollectorAchievement),
                         (_AB.SINGLE, 'dedicationMedal1'): _AchieveFactory.get(
                             _abstract_achievements.DeprecatedAchievement),
                         (_AB.SINGLE, 'dedicationMedal2'): _AchieveFactory.get(
                             _abstract_achievements.DeprecatedAchievement),
                         (_AB.SINGLE, 'dedicationMedal3'): _AchieveFactory.get(
                             _abstract_achievements.DeprecatedAchievement),
                         (_AB.SINGLE, 'dedicationMedal4'): _AchieveFactory.get(
                             _abstract_achievements.DeprecatedAchievement),
                         (_AB.SINGLE, 'TenYearsCountdownParticipation'): _AchieveFactory.get(
                             _abstract_achievements.DeprecatedAchievement),
                         (_AB.TOTAL, 'TenYearsCountdownStageMedal'): _AchieveFactory.get(
                             _abstract_achievements.StageAchievement),
                         (_AB.SINGLE, 'TenYearsCountdownSPGEventMedal'): _AchieveFactory.get(
                             _abstract_achievements.DeprecatedAchievement),
                         (_AB.SINGLE, 'TenYearsCountdownBrawlMedal'): _AchieveFactory.get(
                             _abstract_achievements.DeprecatedAchievement),
                         (_AB.SINGLE, 'BigAnniversaryMedal_CN'): _AchieveFactory.get(
                             _abstract_achievements.DeprecatedAchievement),
                         ...
                         (_AB.SINGLE, 'bob2021Circon_eu'): _AchieveFactory.get(
                             _abstract_achievements.DeprecatedAchievement),
                         (_AB.SINGLE, 'bob2021Dakillzor_eu'): _AchieveFactory.get(
                             _abstract_achievements.DeprecatedAchievement),
                         (_AB.SINGLE, 'bob2021NewMulti2k_eu'): _AchieveFactory.get(
                             _abstract_achievements.DeprecatedAchievement),
                         (_AB.SINGLE, 'bob2021Orzanel_eu'): _AchieveFactory.get(
                             _abstract_achievements.DeprecatedAchievement),
                         (_AB.SINGLE, 'bob2021Cabbagemechanic_na'): _AchieveFactory.get(
                             _abstract_achievements.DeprecatedAchievement),
                         (_AB.SINGLE, 'bob2021TragicLoss_na'): _AchieveFactory.get(
                             _abstract_achievements.DeprecatedAchievement),
                         (_AB.SINGLE, 'bob2021CmdrAF_na'): _AchieveFactory.get(
                             _abstract_achievements.DeprecatedAchievement),
                         (_AB.SINGLE, 'bob2021MasterTortoise_apac'): _AchieveFactory.get(
                             _abstract_achievements.DeprecatedAchievement),
                         (_AB.SINGLE, 'bob2021SummerTiger_apac'): _AchieveFactory.get(
                             _abstract_achievements.DeprecatedAchievement),
                         (_AB.SINGLE, 'bob2021Maharlika_apac'): _AchieveFactory.get(
                             _abstract_achievements.DeprecatedAchievement),
