...
_ACHIEVEMENTS_BY_NAME = {(_AB.TOTAL, 'warrior'): _CustomAchieveFactory.get(_as.regular_ext.WarriorAchievement),
                         ...
                         (_AB.SINGLE, 'BattlePassCommonPr_6'): _AchieveFactory.get(
                             _abstract_achievements.DeprecatedAchievement),
                         (_AB.SINGLE, 'BattlePassCommonPr_7'): _AchieveFactory.get(
                             _abstract_achievements.DeprecatedAchievement),
                         (_AB.SINGLE, 'BattlePassCommonPr_8'): _AchieveFactory.get(
                             _abstract_achievements.DeprecatedAchievement),
                         (_AB.SINGLE, 'BattlePassCommonPr_8ru'): _AchieveFactory.get(
                             _abstract_achievements.DeprecatedAchievement),
                         (_AB.SINGLE, 'BattlePassCommonPr_8quest'): _AchieveFactory.get(
                             _abstract_achievements.DeprecatedAchievement),
                         (_AB.SINGLE, 'BattlePassCommonPr_9'): _AchieveFactory.get(
                             _abstract_achievements.DeprecatedAchievement),
