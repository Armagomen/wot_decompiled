...
__all__ = (
'ArgsEvent', 'ComponentEvent', 'LoadViewEvent', 'LoadGuiImplViewEvent', 'ShowDialogEvent', 'LoginEvent', 'LoginEventEx',
'LobbySimpleEvent', 'FightButtonDisablingEvent', 'FightButtonEvent', 'CloseWindowEvent', 'BrowserEvent',
'HangarVehicleEvent', 'HangarCustomizationEvent', 'GameEvent', 'BootcampEvent', 'ViewEventType', 'OpenLinkEvent',
'ChannelManagementEvent', 'PreBattleChannelEvent', 'AmmunitionSetupViewEvent', 'HasCtxEvent', 'DogTagsEvent',
'FullscreenModeSelectorEvent', 'ModeSelectorPopoverEvent', 'HangarSimpleEvent')
...
class HangarSimpleEvent(HasCtxEvent):
    ...
    EVENT_VEHICLE_PREVIEW_OPEN = 'HangarSimpleEvent/EventVehiclePreviewOpen'
    EVENT_VEHICLE_PREVIEW_CLOSE = 'HangarSimpleEvent/EventVehiclePreviewClose'
