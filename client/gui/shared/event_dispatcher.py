...
from skeletons.gui.game_control import IBrowserController, ICNLootBoxesController, IClanNotificationController, \
    IHeroTankController, IMarathonEventsController, IReferralProgramController, IResourceWellController, \
    ISteamCompletionController, IBoostersController
