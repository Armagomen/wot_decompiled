...
_ClanRatingsData = namedtuple('ClanRatingsData', [
 'clan_id', 'efficiency', 'battles_count_avg', 'wins_ratio_avg', 'xp_avg',
 'gm_elo_rating_6', 'gm_elo_rating_8', 'gm_elo_rating_10',
 'gm_elo_rating_6_rank', 'gm_elo_rating_8_rank', 'gm_elo_rating_10_rank',
 'fb_elo_rating_8', 'fb_elo_rating_10', 'fb_battles_count_10_28d',
 'fs_battles_count_10_28d', 'gm_battles_count_28d',
 'fs_battles_count_28d',
 'fb_battles_count_28d'])
_ClanRatingsData.__new__.__defaults__ = tuple([0] * len(_ClanRatingsData._fields))
_ClanRatingsDataCriticalFields = ('efficiency', 'battles_count_avg', 'wins_ratio_avg',
                                  'xp_avg')
...
_ClanGlobalMapStatsData = namedtuple('ClanGlobalMapStatsData', [
 'battles_lost', 'influence_points', 'provinces_captured',
 'battles_played', 'battles_won', 'battles_played_on_6_level',
 'battles_won_on_6_level', 'battles_played_on_8_level', 'battles_won_on_8_level',
 'battles_played_on_10_level', 'battles_won_on_10_level', 'provinces_count'])
...
_ClanStrongholdInfoData = namedtuple('ClanStrongholdData', [
 'buildings', 'defence_attack_count', 'defence_success_attack_count',
 'defence_battles_count', 'defence_capture_enemy_building_total_count',
 'defence_combat_wins', 'defence_defence_count', 'defence_success_defence_count',
 'defence_enemy_base_capture_count', 'defence_loss_own_building_total_count',
 'defence_resource_capture_count', 'defence_resource_loss_count',
 'sortie_absolute_battles_count', 'sortie_battles_count',
 'sortie_champion_battles_count', 'sortie_fort_resource_in_middle',
 'sortie_fort_resource_in_champion', 'sortie_fort_resource_in_absolute',
 'sortie_middle_battles_count', 'sortie_wins', 'sortie_losses', 'level',
 'total_resource_amount', 'defence_defence_efficiency', 'defence_attack_efficiency',
 'fb_battles_count_8', 'fb_battles_count_10', 'defence_mode_is_activated', 'defence_hour'])
...
_StrongholdStatisticsData = namedtuple('ClanStrongholdData', [
 'elo_10', 'elo_8', 'elo_6',
 'sorties_in_28_days', 'fort_battles_in_28_days',
 'stronghold_level', 'leagues'])
...
_AccountClanData = namedtuple('_AccountClanData', ('account_id', 'joined_at', 'clan_id',
                                                   'role_bw_flag', 'role_name', 'in_clan_cooldown_till'))
_AccountClanData.__new__.__defaults__ = (
 0, _defDateTime, 0, 0, '', _defDateTime)
...
_AccountClanRatingsData = namedtuple('_AccountClanRatingsData', [
 'account_id', 'global_rating', 'battle_avg_xp', 'battles_count',
 'battle_avg_performance', 'xp_amount'])
...
_ClanProvinceData = namedtuple('_ClanProvinceData', [
 'front_name', 'province_id', 'revenue', 'hq_connected',
 'prime_time', 'periphery', 'game_map', 'turns_owned', 'province_id_localized', 'front_name_localized',
 'frontInfo', 'pillage_cooldown', 'pillage_end_datetime', 'arena_id'])
_ClanProvinceData.__new__.__defaults__ = (
 '', 0, 0, False, 0, 0, '', 0, '', None, None, None, None, None)
...
_GlobalMapFrontInfoData = namedtuple('_GlobalMapFrontInfoData', [
 'front_name', 'min_vehicle_level', 'max_vehicle_level'])
...
_ClanSearchData = namedtuple('_ClanSearchData', [
 'name', 'tag', 'motto', 'clan_id', 'leader_id', 'members_count',
 'created_at', 'accepts_join_requests', 'treasury', 'clan_ratings_data'])
_ClanSearchData.__new__.__defaults__ = (
 '', '', '', 0, 0, 0, _defDateTime, False, 0, ClanRatingsData())
...
_ClanInviteData = namedtuple('_ClanInviteData', [
 'account_id', 'clan_id', 'comment', 'created_at',
 'id', 'sender_id', 'status', 'updated_at', 'status_changer_id'])
_ClanInviteData.__new__.__defaults__ = (
 0, 0, '', _defDateTime, 0, 0, '', _defDateTime, 0)
...
_ClanCreateInviteData = namedtuple('_ClanCreateInviteData', [
 'clan_id', 'id', 'account_id'])
...
_ClanADInviteData = namedtuple('_ClanADInviteData', [
 'id', 'transaction_id', 'clan_id', 'account_id'])
...
_ClanFavouriteAttrs = namedtuple('_ClanFavouriteAttrs', [
 'clan_id', 'favorite_arena_6', 'favorite_arena_8', 'favorite_arena_10',
 'favorite_primetime', 'favorite_arenas'])
...
_HofAttrs = namedtuple('_HofAttrs', [
 'status', 'errors'])
