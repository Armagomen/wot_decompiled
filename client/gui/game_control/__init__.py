...
def getGameControllersConfig(manager):
    ...
    from gui.game_control.account_completion import SteamCompletionController as _SteamCompletionController, \
        DemoAccCompletionController as _DemoAccCompletionController
