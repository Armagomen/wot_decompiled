...
_PERSONAL_VO_META.addMeta({'prestigePoints': {}, 'deserterStr': ''})
...
TOURNAMENT_COMP7_PERSONAL_STATS_BLOCK.addComponent(RATING_POINTS_BLOCK_NUMBER, comp7_components.TournamentRatingPointsBlock(_PRESTIGE_POINTS_VO_META, 'prestigePoints', _RECORD.PERSONAL))
TRAINING_COMP7_PERSONAL_STATS_BLOCK.addComponent(RATING_POINTS_BLOCK_NUMBER, comp7_components.TrainingRatingPointsBlock(_PRESTIGE_POINTS_VO_META, 'prestigePoints', _RECORD.PERSONAL))
