from comp7.gui.impl.lobby.page.comp7_platoon_presenter import Comp7PlatoonPresenter
...
class Comp7LobbyFooter(LobbyFooter):

    def _initChildren(self):
        footer = R.aliases.lobby_footer.default
        self._registerChild(footer.Platoon(), Comp7PlatoonPresenter())
