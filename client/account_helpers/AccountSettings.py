...
from account_helpers.settings_core.settings_constants import GAME, BattleCommStorageKeys, ScorePanelStorageKeys, SPGAim, \
    SOUND, AIM, CONTOUR, GuiSettingsBehavior
        ...
        for _, section in filtered:
            ...
            if NEW_SETTINGS_COUNTER in accSettings.keys():
                ...
                if savedNewSettingsCounters is not None:
                    newSettingsCounters = AccountSettings.updateNewSettingsCounter(currentDefaults,
                                                                                   savedNewSettingsCounters)
