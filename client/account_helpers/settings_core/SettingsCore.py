...
class SettingsCore(ISettingsCore):
    ...
    def init(self):
        ...
        (GAME.SHOW_VEHICLE_HP_IN_PLAYERS_PANEL,
         options.VehicleHPInPlayersPanelSetting(GAME.SHOW_VEHICLE_HP_IN_PLAYERS_PANEL,
                                                storage=BATTLE_HUD_SETTINGS_STORAGE)),
        ...
        (GAME.HANGAR_CAM_PARALLAX_ENABLED, options.HangarCamParallaxEnabledSetting(GAME.HANGAR_CAM_PARALLAX_ENABLED,
                                                                                   storage=EXTENDED_GAME_SETTINGS_STORAGE)),
        ...
        (GAME.PLAYERS_PANELS_SHOW_LEVELS,
         options.PlayersPanelSetting(GAME.PLAYERS_PANELS_SHOW_LEVELS, 'players_panel', 'showLevels',
                                     storage=GAME_SETTINGS_STORAGE)),
        ...
        (GAME.GAMEPLAY_EPIC_STANDARD,
         options.GameplaySetting(GAME.GAMEPLAY_MASK, 'ctf30x30', storage=GAMEPLAY_SETTINGS_STORAGE,
                                 delegate=_getEpicRandomSwitch)),
        ...
        (GAME.GAMEPLAY_EPIC_DOMINATION,
         options.GameplaySetting(GAME.GAMEPLAY_MASK, 'domination30x30', storage=GAMEPLAY_SETTINGS_STORAGE,
                                 delegate=_getEpicRandomSwitch)),
        ...
        (GAME.CUSTOMIZATION_DISPLAY_TYPE, options.CustomizationDisplayTypeSetting(GAME.CUSTOMIZATION_DISPLAY_TYPE,
                                                                                  storage=EXTENDED_GAME_2_SETTINGS_STORAGE)),
        ...
        (SPGAim.SCROLL_SMOOTHING_ENABLED,
         options.SPGAimSetting(SPGAim.SCROLL_SMOOTHING_ENABLED, storage=SPG_AIM_SETTINGS_STORAGE)),
        ...
        (TUTORIAL.TECHNICAL_MAINTENANCE,
         options.TutorialSetting(TUTORIAL.TECHNICAL_MAINTENANCE, storage=TUTORIAL_SETTINGS_STORAGE)),
        ...
        (TUTORIAL.FIRE_EXTINGUISHER_USED,
         options.TutorialSetting(TUTORIAL.FIRE_EXTINGUISHER_USED, storage=TUTORIAL_SETTINGS_STORAGE)),
        (TUTORIAL.WAS_QUESTS_TUTORIAL_STARTED,
         options.TutorialSetting(TUTORIAL.WAS_QUESTS_TUTORIAL_STARTED, storage=TUTORIAL_SETTINGS_STORAGE)),
        ...
        (DAMAGE_LOG.ASSIST_STUN,
         options.BattleEventsSetting(DAMAGE_LOG.ASSIST_STUN, storage=DAMAGE_LOG_SETTINGS_STORAGE,
                                     delegate=_getStunSwitch)),
        ...
        (BATTLE_EVENTS.ENEMY_ASSIST_STUN,
         options.BattleEventsSetting(BATTLE_EVENTS.ENEMY_ASSIST_STUN, storage=BATTLE_EVENTS_SETTINGS_STORAGE,
                                     delegate=_getStunSwitch)),
        ...
        (BATTLE_BORDER_MAP.MODE_SHOW_BORDER, options.BattleBorderMapModeShow(BATTLE_BORDER_MAP.MODE_SHOW_BORDER,
                                                                             storage=BATTLE_BORDER_MAP_SETTINGS_STORAGE)),
