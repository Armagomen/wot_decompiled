...
class ClientSelectableCameraObject(ClientSelectableObject, CallbackDelayer, TimeDeltaMeter):
    ...
    def onEnterWorld(self, prereqs):
        ...
        g_eventBus.addListener(events.HangarSimpleEvent.SHOW_CONFIRM_DIALOG, self.__onShowConfirmDialog,
                               EVENT_BUS_SCOPE.LOBBY)
        g_eventBus.addListener(events.HangarSimpleEvent.CLOSE_CONFIRM_DIALOG, self.__onCloseConfirmDialog,
                               EVENT_BUS_SCOPE.LOBBY)

    def onLeaveWorld(self):
        g_eventBus.removeListener(events.HangarSimpleEvent.SHOW_CONFIRM_DIALOG, self.__onShowConfirmDialog,
                                  EVENT_BUS_SCOPE.LOBBY)
        g_eventBus.removeListener(events.HangarSimpleEvent.CLOSE_CONFIRM_DIALOG, self.__onCloseConfirmDialog,
                                  EVENT_BUS_SCOPE.LOBBY)
