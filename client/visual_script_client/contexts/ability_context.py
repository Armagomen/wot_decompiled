...
class AbilityContextClient(VehicleContextClient):
    ...
    @vse_event_out(display_name='OnCanActive', description='Calls to check whether ability can be activated',
    ...
    @vse_event_out(display_name='OnCooldown', description='Calls when ability becomes cooldown',
                   aspects=[ASPECT.CLIENT])
    def cooldown(self):
        pass

    @vse_event_out(display_name='OnExhausted', description='Calls when ability becomes exhausted',
                   aspects=[ASPECT.CLIENT])
    def exhausted(self):
        pass

    @vse_event_out(display_name='OnPrepared', description='Calls when ability becomes preparing',
                   aspects=[ASPECT.CLIENT])
    def preparing(self):
        pass
    ...
    @vse_event_out(display_name='OnDeploying', description='Calls when ability becomes deploying',
                   aspects=[ASPECT.CLIENT])
    def deploying(self):
        pass
