...
class HangarSelectableLogic(BaseSelectableLogic):
    __slots__ = (
    '__selected3DEntity', '__selected3DEntityUnderMouseDown', '__isHighlightingEnabled', '__is3DEntityClickable')
    ...
    def __init__(self):
        ...
        g_eventBus.addListener(events.HangarSimpleEvent.EVENT_VEHICLE_PREVIEW_OPEN, self.__eventVehiclePreviewOpen,
                               EVENT_BUS_SCOPE.LOBBY)
        g_eventBus.addListener(events.HangarSimpleEvent.EVENT_VEHICLE_PREVIEW_CLOSE, self.__eventVehiclePreviewClose,
                               EVENT_BUS_SCOPE.LOBBY)
        return
    ...
    def fini(self):
        ...
        if self.__selected3DEntity is not None:
            ...
            self.__selected3DEntity = None
        g_eventBus.removeListener(events.HangarSimpleEvent.EVENT_VEHICLE_PREVIEW_OPEN, self.__eventVehiclePreviewOpen,
                                  EVENT_BUS_SCOPE.LOBBY)
        g_eventBus.removeListener(events.HangarSimpleEvent.EVENT_VEHICLE_PREVIEW_CLOSE, self.__eventVehiclePreviewClose,
                                  EVENT_BUS_SCOPE.LOBBY)
