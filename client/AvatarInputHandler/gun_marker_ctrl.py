...
class _CrosshairShotResults(object):
    ...
    'normAngle', 'ricochetAngle', 'mayRicochet', 'checkCaliberForRicochet', 'jetLossPPByDist'))
    _SHELL_EXTRA_DATA = {
        constants.SHELL_TYPES.ARMOR_PIERCING: shellExtraData(math.radians(5.0), math.cos(math.radians(70.0)), True,
                                                             True, 0.0),
        constants.SHELL_TYPES.ARMOR_PIERCING_CR: shellExtraData(math.radians(2.0), math.cos(math.radians(70.0)), True,
                                                                True, 0.0),
