...
from fun_random.gui.impl.lobby.hangar.presenters.fun_random_vehicle_menu_easy_equip_presenter import FunRandomEasyEquipMenuEntrySubPresenter
...
class FunRandomHangarVehicleMenuHelper(IHangarVehicleMenuHelper):
    ...
    def getMenuEntries(cls):
        ...
        return {vehicleMenu.Customization(): CustomizationEntrySubPresenter, 
           ...
           vehicleMenu.EasyEquip(): FunRandomEasyEquipMenuEntrySubPresenter, 
