...
LS_TOTAL_VO_META = base.DictMeta({'common': {}, 'phase': 0, 
   'phasesCount': 0, 
   'players': [], 'quests': None, 
...
LS_TEAM_ITEM_VO_META = base.PropertyMeta((
 ...
 ('progressPoints', 0, 'progressPoints'),
 (
...
LS_PERSONAL_REWARDS_BLOCK.addNextComponent(ex.LSEffectivenessPointsItem('effectivenessPoints', _RECORD.PERSONAL))
LS_PERSONAL_REWARDS_BLOCK.addNextComponent(ex.LSObeliskPointsItem('obeliskPoints', _RECORD.PERSONAL))
