...
class LSEventBanner(BaseEventBanner):
    ...
    _lsDifficultyMissionsCtrl = dependency.descriptor(ILSDifficultyMissionsController)
    ...
    def inProgressDescription(self):
        res = R.strings.hangar_event_banners.event.LSEntryPoint
        if self._lsArtefactsCtrl.isProgressCompleted() and self._lsDifficultyMissionsCtrl.isProgressCompleted():
    ...
    def onAppear(self):
        ...
        self._lsDifficultyMissionsCtrl.onDifficultyMissionsStatusUpdated += self.__onUpdate
