...
class LSConsumableInteractor(ConsumableInteractor):
    ...
    def getVehicleAfterInstall(self):
        vehicle = super(LSConsumableInteractor, self).getVehicleAfterInstall()
    ...
    def revert(self):
        ...
        super(LSConsumableInteractor, self).revert()

    def updateFrom(self, vehicle, onlyInstalled=True):
        super(LSConsumableInteractor, self).updateFrom(vehicle, onlyInstalled)
    ...
    def _createAutoRenewal(self):
        return LSConsumableAutoRenewal(self.getItem())
...
class LSConsumableAutoRenewal(BaseAutoRenewal):
