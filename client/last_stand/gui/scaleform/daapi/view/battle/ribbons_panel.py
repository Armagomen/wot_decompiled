...
class LSBattleRibbonsPanel(BattleRibbonsPanel):
    ...
    def __init__(self):
        ...
        battleEfficiencyTypes = [ ribbon.TYPE for ribbon in viewvalues(ribbons_aggregator.LSReceiveDamageRibbonsFactory.ATTACK_REASONS) ]
    ...
    def _shouldShowRibbon(self, ribbon):
        ...
        if not result:
            return False
        return getattr(ribbon, 'shouldShow', True)

    def _getRibbonsConfig(self):
        result = super(LSBattleRibbonsPanel, self)._getRibbonsConfig()
        result.extend([
         [
          LS_BATTLE_EFFICIENCY_TYPES.LS_DMG_VAMPIRE,
          backport.text(R.strings.last_stand_battle.efficiencyRibbons.damageVampire())],
         [
          LS_BATTLE_EFFICIENCY_TYPES.LS_AOE_BURN,
          backport.text(R.strings.last_stand_battle.efficiencyRibbons.aoeBurn())],
         [
          LS_BATTLE_EFFICIENCY_TYPES.LS_AOE_DAMAGE,
          backport.text(R.strings.last_stand_battle.efficiencyRibbons.aoeDamage())],
         [
          LS_BATTLE_EFFICIENCY_TYPES.LS_SHOT_AOE_DAMAGE,
          backport.text(R.strings.last_stand_battle.efficiencyRibbons.instantShotAoeDamage())],
         [
          LS_BATTLE_EFFICIENCY_TYPES.LS_SHOT_AOE_DRAIN_ENEMY_HP,
          backport.text(R.strings.last_stand_battle.efficiencyRibbons.instantShotAoeDrainEnemyHp())],
         [
          LS_BATTLE_EFFICIENCY_TYPES.LS_SHOT_AOE_STUN,
          backport.text(R.strings.last_stand_battle.efficiencyRibbons.instantShotAoeStun())],
         [
          LS_BATTLE_EFFICIENCY_TYPES.LS_REPAIR,
          backport.text(R.strings.last_stand_battle.efficiencyRibbons.repair())],
         [
          LS_BATTLE_EFFICIENCY_TYPES.LS_REPAIR_OTHER,
          backport.text(R.strings.last_stand_battle.efficiencyRibbons.repairOther())],
         [
          LS_BATTLE_EFFICIENCY_TYPES.LS_REPAIR_BY_OTHER,
          backport.text(R.strings.last_stand_battle.efficiencyRibbons.repairByOther())],
         [
          LS_BATTLE_EFFICIENCY_TYPES.LS_MODULES_DAMAGE_BLOCKED,
          backport.text(R.strings.last_stand_battle.efficiencyRibbons.modulesDamageBlocked())],
         [
          LS_BATTLE_EFFICIENCY_TYPES.LS_PASSIVE_IGNITE,
          backport.text(R.strings.ingame_gui.efficiencyRibbons.burn())],
         [
          LS_BATTLE_EFFICIENCY_TYPES.LS_PASSIVE_VAMPIRE,
          backport.text(R.strings.last_stand_battle.efficiencyRibbons.passiveVampire())],
         [
          LS_BATTLE_EFFICIENCY_TYPES.LS_REPAIR_VEHICLE_BY_OBELISK,
          backport.text(R.strings.last_stand_battle.efficiencyRibbons.repairByObelisk())],
         [
          LS_BATTLE_EFFICIENCY_TYPES.LS_BOMBER_EXPLOSION,
          backport.text(R.strings.last_stand_battle.efficiencyRibbons.bomberExplosion())],
         [
          LS_BATTLE_EFFICIENCY_TYPES.LS_DMG_VAMPIRE_RECEIVED,
          backport.text(R.strings.last_stand_battle.efficiencyRibbons.damageVampire())],
         [
          LS_BATTLE_EFFICIENCY_TYPES.LS_AOE_DAMAGE_RECEIVED,
          backport.text(R.strings.last_stand_battle.efficiencyRibbons.aoeDamage())],
         [
          LS_BATTLE_EFFICIENCY_TYPES.LS_NITRO_ACTIVATED,
          backport.text(R.strings.last_stand_battle.efficiencyRibbons.nitroActivated())],
         [
          LS_BATTLE_EFFICIENCY_TYPES.LS_HEAL_SITUATIONAL,
          backport.text(R.strings.last_stand_battle.efficiencyRibbons.healSituational())],
         [
          LS_BATTLE_EFFICIENCY_TYPES.LS_EXTRA_DAMAGE_SITUATIONAL,
          backport.text(R.strings.last_stand_battle.efficiencyRibbons.extraDamageSituational())]])
        return result
    ...
    def _canBeShown(self, ribbon):
        ...
        if not base:
            ...
            if delayedTill is not None:
                return BigWorld.time() >= delayedTill
            return True
