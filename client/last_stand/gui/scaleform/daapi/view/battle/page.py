        ...
        super(_ComponentsConfig, self).__init__((
         ...
         (
          ...
          (
           ...
           LS_ALIASES.CONVOY_BATTLE_HINT))), viewsConfig=(
         (
...
_EXTERNAL_COMPONENTS = (
 LSCrosshairPanelContainer, LSMarkersManager)
_POSTMORTEM_HIDE_VIEW = {
 LS_ALIASES.POINT_COUNTER, BATTLE_VIEW_ALIASES.BATTLE_DAMAGE_LOG_PANEL, BATTLE_VIEW_ALIASES.CONSUMABLES_PANEL,
...
class LastStandBattlePage(LastStandBattlePageMeta):
    ...
    def __onRoundFinished(self, winningTeam, reason):
        aliases = {
         BATTLE_VIEW_ALIASES.HINT_PANEL, LS_ALIASES.PINNABLE_BATTLE_HINT, LS_ALIASES.CONVOY_BATTLE_HINT,
         LS_ALIASES.PROGRESS_BAR_BATTLE_HINT, BATTLE_VIEW_ALIASES.EVENT_TIMER}
