...
def getViewSettings():
    ...
    return (
     ViewSettings(VIEW_ALIAS.INGAME_MENU, LSIngameMenu, 'ingameMenu.swf', WindowLayer.TOP_WINDOW, None, ScopeTemplates.DEFAULT_SCOPE, isModal=True, canClose=False, canDrag=False),
