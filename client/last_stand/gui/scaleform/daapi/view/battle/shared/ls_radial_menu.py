...
REGULAR_BOTTOM_STATIC_SHORTCUTS = (
 Shortcut(title=INGAME_HELP.RADIALMENU_RELOADINGGUN, action=BATTLE_CHAT_COMMAND_NAMES.RELOADINGGUN, icon=RADIAL_MENU_CONSTS.RELOAD, groups=LS_RADIAL_MENU_CONSTS.WHITE_TARGET_STATES, bState=RADIAL_MENU_CONSTS.NORMAL_BUTTON_STATE, indexInGroup=RADIAL_MENU_CONSTS.ELEMENT_INDEX_THIRD),
 Shortcut(title=INGAME_HELP.RADIALMENU_HELPME, action=BATTLE_CHAT_COMMAND_NAMES.SOS, icon=RADIAL_MENU_CONSTS.SOS, groups=LS_RADIAL_MENU_CONSTS.WHITE_TARGET_STATES, bState=RADIAL_MENU_CONSTS.NORMAL_BUTTON_STATE, indexInGroup=RADIAL_MENU_CONSTS.ELEMENT_INDEX_FOURTH))
REGULAR_UPPER_STATIC_SHORTCUTS = (
 Shortcut(title=RADIAL_MENU_CONSTS.EMPTY_BUTTON_STATE, action=RADIAL_MENU_CONSTS.EMPTY_BUTTON_STATE, icon=RADIAL_MENU_CONSTS.EMPTY_BUTTON_STATE, groups=LS_RADIAL_MENU_CONSTS.WHITE_TARGET_STATES, bState=RADIAL_MENU_CONSTS.EMPTY_BUTTON_STATE, indexInGroup=RADIAL_MENU_CONSTS.ELEMENT_INDEX_FIFTH),
 ...
 Shortcut(title='#last_stand.last_stand_battle:radialMenu/move_to_magnus', action=BATTLE_CHAT_COMMAND_NAMES.MOVING_TO_TARGET_POINT, icon=LS_RADIAL_MENU_CONSTS.LS_MAGNUS, groups=[
  LS_RADIAL_MENU_CONSTS.TARGET_STATE_LS_MAGNUS], bState=RADIAL_MENU_CONSTS.NORMAL_BUTTON_STATE, indexInGroup=RADIAL_MENU_CONSTS.ELEMENT_INDEX_FIRST),
 Shortcut(title='#last_stand.last_stand_battle:radialMenu/attention_here', action=BATTLE_CHAT_COMMAND_NAMES.MOVE_TO_TARGET_POINT, icon=LS_RADIAL_MENU_CONSTS.LS_MAGNUS_HELP, groups=[
  LS_RADIAL_MENU_CONSTS.TARGET_STATE_LS_MAGNUS], bState=RADIAL_MENU_CONSTS.NORMAL_BUTTON_STATE, indexInGroup=RADIAL_MENU_CONSTS.ELEMENT_INDEX_SIXTH),
 Shortcut(title='#last_stand.last_stand_battle:radialMenu/move_to_camp', action=BATTLE_CHAT_COMMAND_NAMES.MOVING_TO_TARGET_POINT, icon=LS_RADIAL_MENU_CONSTS.LS_CAMP, groups=[
  LS_RADIAL_MENU_CONSTS.TARGET_STATE_LS_CAMP], bState=RADIAL_MENU_CONSTS.NORMAL_BUTTON_STATE, indexInGroup=RADIAL_MENU_CONSTS.ELEMENT_INDEX_FIRST),
 Shortcut(title='#last_stand.last_stand_battle:radialMenu/attention_here', action=BATTLE_CHAT_COMMAND_NAMES.MOVE_TO_TARGET_POINT, icon=LS_RADIAL_MENU_CONSTS.LS_CAMP_HELP, groups=[
  LS_RADIAL_MENU_CONSTS.TARGET_STATE_LS_CAMP], bState=RADIAL_MENU_CONSTS.NORMAL_BUTTON_STATE, indexInGroup=RADIAL_MENU_CONSTS.ELEMENT_INDEX_SIXTH))
...
class LSRadialMenu(RadialMenu):
    ...
    def _getCanReplayShortcut(self, shortcut, canReplyAction):
        if shortcut.action == BATTLE_CHAT_COMMAND_NAMES.MOVING_TO_TARGET_POINT:
            return Shortcut(title='#last_stand.last_stand_battle:radialMenu/confirm', action=canReplyAction, icon=RADIAL_MENU_CONSTS.YES, groups=LS_RADIAL_MENU_CONSTS.WHITE_TARGET_STATES, bState=RADIAL_MENU_CONSTS.NORMAL_BUTTON_STATE, indexInGroup=shortcut.indexInGroup)
        return super(LSRadialMenu, self)._getCanReplayShortcut(shortcut, canReplyAction)
