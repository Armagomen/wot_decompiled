...
class _LSHighPriorityGroup(components.StatusNotificationsGroup):
    ...
    def __init__(self, updateCallback):
        super(_LSHighPriorityGroup, self).__init__((
         _LS_SW_ITEMS.LSStaticDeathZoneSN,
         sn_items.FireSN,
...
class LSStatusNotificationTimerPanel(StatusNotificationTimerPanel):
    ...
    def _generateItems(self):
        items = [
         _LSHighPriorityGroup,
         _LS_SW_ITEMS.ShieldBuffSN,
    ...
    def _generateNotificationTimerSettings(self):
        ...
        self._addNotificationTimerSetting(data, _LSTYPES.LS_SHIELD, _LSLINKS.LS_SHIELD, _LINKS.SECONDARY_TIMER_UI, iconSmallName=_LSLINKS.LS_SHIELD, color=_COLORS.GREEN)
