...
def getViewSettings():
    ...
    from last_stand.gui.scaleform.daapi.view.battle.obelisk_indicator import LSObeliskIndicator
    return (
     ViewSettings(VIEW_ALIAS.LAST_STAND_BATTLE_PAGE, LastStandBattlePage, getSwfExtensionUrl('last_stand', 'LastStandBattlePage.swf'), WindowLayer.VIEW, None, ScopeTemplates.DEFAULT_SCOPE),
     ...
     ComponentSettings(LS_BATTLE_VIEW_ALIASES.OBELISK, LSObeliskIndicator, ScopeTemplates.DEFAULT_SCOPE))


def getBusinessHandlers():
    return (
     _LastStandPackageBusinessHandler(),)
...
class _LastStandPackageBusinessHandler(PackageBusinessHandler):
    ...
    def __init__(self):
        listeners = (
         (
          VIEW_ALIAS.LAST_STAND_BATTLE_PAGE, self._loadPage),)
