...
class LSEquipmentPanelSounds(SoundComponentBase):
    ACTIVE_EQUIPMENT_STAGES = (
     EQUIPMENT_STAGES.DEPLOYING, EQUIPMENT_STAGES.PREPARING, EQUIPMENT_STAGES.ACTIVE,
    ...
    def _getPlayerVehicleSoulsContainer(self):
        ...
        if vehicle:
            return vehicle.dynamicComponents.get('lsSoulsContainer')
        else:
            return
