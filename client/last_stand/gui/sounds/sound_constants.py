...
META_STORY_POINT_OPEN_SOUND = 'ev_last_stand_quantum{}_enter'
META_STORY_POINT_CLOSE_SOUND = 'ev_last_stand_quantum{}_exit'
...
REWARD_WINDOW_ENTER = 'ev_last_stand_reward_screen_enter'
REWARD_WINDOW_EXIT = 'ev_last_stand_reward_screen_exit'
...
BOTS_SPAWN = {'germany:G00_Bomber_LS_BOT': 'ev_gp_bot_bomber_spawn', 
   'germany:G00_Obelisk_01_LS_bot': 'ev_gp_bot_obelisk_spawn_3D', 
   'germany:G00_Obelisk_02_LS_bot': 'ev_gp_bot_obelisk_spawn_3D', 
   'germany:G00_Obelisk_03_LS_bot': 'ev_gp_bot_obelisk_spawn_3D'}
...
class PostMortemSounds(CONST_CONTAINER):
    ON = 'ev_last_stand_postmortem_on'
    OFF = 'ev_last_stand_postmortem_off'
...
class BattleEquipmentPanelSounds(CONST_CONTAINER):
    ACTIVATE = 'ev_last_stand_gp_ui_ability_button'
    READY = 'ev_last_stand_gp_ui_ability_button_ready'
    NOT_READY = 'ev_last_stand_gp_ui_ability_button_not_ready'


class LootSounds(CONST_CONTAINER):

    class Player(CONST_CONTAINER):
        PICKUP_SUCCEED = {'LS_lootSoulsSmall': 'ev_last_stand_collect_pc_player', 
           'LS_lootSoulsMedium': 'ev_last_stand_collect_pc_player', 
           'LS_lootSoulsBig': 'ev_last_stand_collect_pc_player', 
...
HANGAR_SOUND_SETTINGS = CommonSoundSpaceSettings(name='lsHangar', entranceStates={HangarSoundStates.PLACE.value: HangarSoundStates.PLACE_GARAGE.value, StatesGroup.HANGAR_FILTERED: States.HANGAR_FILTERED_OFF}, exitStates={}, persistentSounds=(), stoppableSounds=(), priorities=(), autoStart=True, enterEvent='', exitEvent='')
...
class LastStandVO(CONST_CONTAINER):
    ...
    BATTLE_STARTED = Voiceover('ev_last_stand_vo_start', aliveOnly=True)
...
class ObeliskBattleSound(CONST_CONTAINER):
    HIT_2D = 'ev_gp_bot_obelisk_weak_zone_hit_2d'
    HIT_3D = 'ev_gp_bot_obelisk_weak_zone_hit_3d'