...
class Material(pybind11_object):
	def __delattr__(*args, **kwargs): pass
	__doc__ = None
	def __format__(*args, **kwargs): pass
...
class Weather(pybind11_object):
	...
	def __str__(*args, **kwargs): pass
	def __subclasshook__(*args, **kwargs): pass
	def windAverage(self, *args, **kwargs): pass
	def windGustiness(self, *args, **kwargs): pass

__doc__ = None
__name__ = 'Romp'
__package__ = None
def weather(*args, **kwargs): pass