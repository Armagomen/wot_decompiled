...
class ArcadeAimingSystem(IAimingSystem):
	...
	def adjustDistanceFromFocus(self, *args, **kwargs): pass
	aimMatrix = property(lambda self: None)
...
class ArenaBorderHelper(pybind11_object):
	...
	def __str__(*args, **kwargs): pass
	def __subclasshook__(*args, **kwargs): pass
	def enableArenaCenterPoint(*args, **kwargs): pass
	def enableCenterPoint(*args, **kwargs): pass
	...
	def setArenaCenterAlpha(*args, **kwargs): pass
	def setArenaCenterHeight(*args, **kwargs): pass
	def setArenaGroundLineAlpha(*args, **kwargs): pass
	def setArenaGroundLineHeight(*args, **kwargs): pass
	...
	def setCenterAlpha(*args, **kwargs): pass
	def setCenterHeight(*args, **kwargs): pass
	def setGroundLineAlpha(*args, **kwargs): pass
	def setGroundLineHeight(*args, **kwargs): pass
...
class DeathCamera(HomingCamera):
	def __delattr__(*args, **kwargs): pass
	__doc__ = None
	def __format__(*args, **kwargs): pass
	def __getattribute__(*args, **kwargs): pass
	...
	pivotPositionProvider = property(lambda self: None)
	playerSpace = property(lambda self: None)
	position = property(lambda self: None)
	def render(self, *args, **kwargs): pass
	...
	spaceID = property(lambda self: None)
	speedTreeTarget = property(lambda self: None)
	def startDistanceAnimation(self, *args, **kwargs): pass
	def startLockOnMatrix(self, *args, **kwargs): pass
	def startNewSpin(self, *args, **kwargs): pass
	def startYawAndPitch(self, *args, **kwargs): pass
	def stopAllMovements(self, *args, **kwargs): pass
	up = property(lambda self: None)
	def update(self, *args, **kwargs): pass
...
class FreeCamera(SpeedTreeTargetedCamera):
	...
	def __str__(*args, **kwargs): pass
	def __subclasshook__(*args, **kwargs): pass
	def checkCollision(self, *args, **kwargs): pass
	direction = property(lambda self: None)
...
class LerpPositionMatrixProvider(MatrixProvider):
	def __delattr__(*args, **kwargs): pass
	__doc__ = None
	def __format__(*args, **kwargs): pass
	def __getattribute__(*args, **kwargs): pass
	...
	__module__ = 'BigWorld'
	def __new__(*args, **kwargs): pass
	__qualname__ = 'LerpPositionMatrixProvider'
	def __reduce__(*args, **kwargs): pass
	def __reduce_ex__(*args, **kwargs): pass
	def __repr__(*args, **kwargs): pass
	def __setattr__(*args, **kwargs): pass
...
class PolygonalAreaBorder(pybind11_object):
	...
	def getDimensions(self, *args, **kwargs): pass
...
class StrategicAimingSystem(BaseStrategicAimingSystem):
	...
	def __subclasshook__(*args, **kwargs): pass
	aimMatrix = property(lambda self: None)
	def clampMinimalAimingRadius(self, *args, **kwargs): pass
	def destroy(self, *args, **kwargs): pass
	def disable(self, *args, **kwargs): pass
	def enable(self, *args, **kwargs): pass
	def getCamDist(self, *args, **kwargs): pass
...
class WGRenderSettings(pybind11_object):
	...
	def getFadeParams(self, *args, **kwargs): pass
	def getPosteffectsSettings(self, *args, **kwargs): pass
	def getVignetteSettings(self, *args, **kwargs): pass
	def removeFlashBangAnimation(self, *args, **kwargs): pass
	def setFadeParams(self, *args, **kwargs): pass
...
class WGStickerModel(PyAttachment):
	...
	inWorld = property(lambda self: None)
	matrix = property(lambda self: None)
	def resetReceiverId(self, *args, **kwargs): pass
	...
	def setReceiverId(self, *args, **kwargs): pass
...
class WGVehicleFilter(WGEntityFilter):
	...
	enableClientFilters = True
	def enableLagDetection(self, *args, **kwargs): pass
	def enablePitchHullAiming(self, *args, **kwargs): pass
	def enableStabilisedMatrix(self, *args, **kwargs): pass
	...
	gunMatrix = property(lambda self: None)
	hullAimingPitch = property(lambda self: None)
	...
	def transferInputAsVehicle(self, *args, **kwargs): pass
	turretMatrix = property(lambda self: None)
	def updateHullAimingPitch(self, *args, **kwargs): pass
...
class WGWarplaneMotor(Motor):
	...
	def __str__(*args, **kwargs): pass
	def __subclasshook__(*args, **kwargs): pass
	isPaused = property(lambda self: None)
	owner = property(lambda self: None)
	def pause(self, *args, **kwargs): pass
...
class WGWinNotifier(pybind11_object):
	...
	def __str__(*args, **kwargs): pass
	def __subclasshook__(*args, **kwargs): pass
	def onAFKWarning(self, *args, **kwargs): pass
...
def logExceptionFrame(*args, **kwargs): pass
def logExceptionTraceback(*args, **kwargs): pass
...
def wg_collideSphereDynamicStatic(*args, **kwargs): pass
def wg_collideWater(*args, **kwargs): pass
def wg_computeProjectileTrajectory(*args, **kwargs): pass
def wg_computeProjectileTrajectoryWithEnd(*args, **kwargs): pass
...
def wg_getMods(*args, **kwargs): pass
...
def wg_reportSessionData(*args, **kwargs): pass
def wg_reportSystemData(*args, **kwargs): pass
...
def wg_setHideEdges(*args, **kwargs): pass
def wg_setHourOfDay(*args, **kwargs): pass
def wg_setKillAllActiveEffects(*args, **kwargs): pass
...
def wg_setWorldTimeScale(*args, **kwargs): pass
...
def wg_withholdEntityTypes(*args, **kwargs): pass
