...
MAX_DISCOUNT_VALUE = 2147483647
MAX_TIMESTAMP_VALUE = 9007199254740991
MAX_DISCOUNT_COEFFICIENT = 10
DIGITAL_TEMPLATE = '([1-9]\\d*((_|\\.)\\d+)?)'
...
ExchangeDiscountInfo = namedtuple('ExchangeDiscountInfo', ('isPersonal', 'exchangeType',
                                                           'discountType', 'goldRateValue',
                                                           'resourceRateValue', 'showFormat',
                                                           'amountOfDiscount', 'discountLifetime',
                                                           'tokenName'))
