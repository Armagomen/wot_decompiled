...
class TestEnum(unittest.TestCase):
    ...
    if pyver >= 3.0:
        ...
        def test_dir_on_class(self):
            Season = self.Season
            self.assertEqual(set(dir(Season)), set(['__class__', '__doc__', '__members__', '__module__',
             'SPRING', 'SUMMER', 'AUTUMN', 'WINTER']))

        def test_dir_on_item(self):
            Season = self.Season
            self.assertEqual(set(dir(Season.WINTER)), set(['__class__', '__doc__', '__module__', 'name', 'value']))
    ...
    def test_enum(self):
        ...
        for i, season in enumerate(('SPRING SUMMER AUTUMN WINTER').split()):
            ...
            self.assertEqual(repr(e), '<Season.%s: %s>' % (season, i))
    ...
    def test_enum_duplicates(self):
        ...
        self.assertEqual(set([ k for k, v in Season.__members__.items() if v.name != k ]), set(['FALL', 'ANOTHER_SPRING']))
    ...
    if pyver == 3.4:
        ...
        def test_class_nested_enum_and_pickle_protocol_four(self):
            ...
            test_pickle_exception(self.assertRaises, PicklingError, self.NestedEnum.twigs, protocol=(0,
                                                                                                     3))
            test_pickle_dump_load(self.assertTrue, self.NestedEnum.twigs, protocol=(
             4, HIGHEST_PROTOCOL))
    ...
    def test_iteration_order(self):
        ...
        self.assertEqual(list(Season), [
         Season.SUMMER, Season.WINTER, Season.AUTUMN, Season.SPRING])

    def test_iteration_order_reversed(self):
        self.assertEqual(list(reversed(self.Season)), [
    ...
    def test_programatic_function_string(self):
        ...
        self.assertEqual([
         SummerMonth.june, SummerMonth.july, SummerMonth.august], lst)
    ...
    def test_programatic_function_from_unicode_dict(self):
        SummerMonth = Enum('SummerMonth', dict(((unicode('june'), 1), (unicode('july'), 2), (unicode('august'), 3))))
        lst = list(SummerMonth)
        self.assertEqual(len(lst), len(SummerMonth))
        self.assertEqual(len(SummerMonth), 3, SummerMonth)
        if pyver < 3.0:
    ...
    def test_programmatic_function_unicode_class(self):
        if pyver < 3.0:
            class_names = (
             unicode('SummerMonth'), (b'S\xfcmm\xe9rM\xf6nth').decode('latin1'))
        else:
            class_names = ('SummerMonth', b'S\xfcmm\xe9rM\xf6nth')
    ...
    def test_duplicate_values_give_unique_enum_items(self):
        ...
        self.assertEqual(list(AutoNumber), [
