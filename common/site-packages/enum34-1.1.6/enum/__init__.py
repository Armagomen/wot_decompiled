...
# Embedded file name: scripts/common/site-packages/enum34-1.1.6/enum/__init__.py
# Compiled at: 2053-04-30 01:44:02
"""Python Enumerations"""
import sys as _sys
...
class EnumMeta(type):
    ...
    def __call__(cls, value, names=None, module=None, type=None, start=1):
        ...
        """
        return cls.__new__(cls, value) if names is None else cls._create_(value, names, module=module, type=type,
                                                                          start=start)
...
def __eq__(self, other):
    return self is other if type(other) is self.__class__ else NotImplemented
...
def __ne__(self, other):
    return self is not other if type(other) is self.__class__ else NotImplemented
