...
# Embedded file name: scripts/common/site-packages/future-0.18.2/future/tests/base.py
...
def expectedFailurePY3(func):
    return func if not PY3 else unittest.expectedFailure(func)


def expectedFailurePY26(func):
    return func if not PY26 else unittest.expectedFailure(func)


def expectedFailurePY27(func):
    return func if not PY27 else unittest.expectedFailure(func)


def expectedFailurePY2(func):
    return func if not PY2 else unittest.expectedFailure(func)
