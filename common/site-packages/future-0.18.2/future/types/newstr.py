...
# Embedded file name: scripts/common/site-packages/future-0.18.2/future/types/newstr.py
from future.types import no, issubset
from future.utils import PY3, with_metaclass, isnewbytes
