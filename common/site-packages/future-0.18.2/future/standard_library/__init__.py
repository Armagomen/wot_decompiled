...
# Embedded file name: scripts/common/site-packages/future-0.18.2/future/standard_library/__init__.py
...
class RenameImport(object):
    ...
    def find_module(self, fullname, path=None):
        ...
        return self if fullname in new_base_names else None
...
class exclude_local_folder_imports(object):
    ...
    def __enter__(self):
        ...
        if sys.version_info[0] < 3:
            return
        FUTURE_SOURCE_SUBFOLDERS = ['future',
         'past',
         'libfuturize',
         'libpasteurize',
         'builtins']
