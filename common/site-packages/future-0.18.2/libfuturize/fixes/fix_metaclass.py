...
# Embedded file name: scripts/common/site-packages/future-0.18.2/libfuturize/fixes/fix_metaclass.py
        ...
        if not has_metaclass(node):
            ...
            if arglist.children:
                if len(arglist.children) == 1:
                    ...
                    bases.prefix = u' '
                    base = Call(Name('type'), [String("'NewBase'"),
                     Comma(),
                     bases,
                     Comma(),
                     Node(syms.atom, [Leaf(token.LBRACE, u'{'), Leaf(token.RBRACE, u'}')], prefix=u' ')], prefix=u' ')
