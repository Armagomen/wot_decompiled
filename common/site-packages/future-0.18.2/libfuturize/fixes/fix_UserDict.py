...
# Embedded file name: scripts/common/site-packages/future-0.18.2/libfuturize/fixes/fix_UserDict.py
from lib2to3.fixer_util import Name, attr_chain
from lib2to3.fixes.fix_imports import build_pattern, FixImports
