...
# Embedded file name: scripts/common/site-packages/future-0.18.2/libfuturize/fixer_util.py
import re
from lib2to3.pygram import python_symbols as syms
from lib2to3.pygram import token
from lib2to3.pytree import Leaf, Node

from lib2to3.fixer_util import FromImport, Newline, is_import, find_root, does_tree_import
from lib2to3.fixer_util import Node, Call, Name, syms, Comma
...
def check_future_import(node):
    ...
    return set([node.value]) if node.type == token.NAME else None
