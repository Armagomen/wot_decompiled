...
import pympler.asizeof as asizeof, pympler.process
__all__ = [
 'ClassTracker']
_local_start = time()
...
class TrackedObject(object):
    __slots__ = ('ref', 'id', 'repr', 'name', 'birth', 'death', 'trace', 'snapshots',
                 '_resolution_level', '__dict__')
