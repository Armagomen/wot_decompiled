...
EQUIPMENT_NAME_TO_GENERIC_OPTIONAL_DEVICE_MAP = {'stereoscope': GenericOptionalDevice.STEREOSCOPE, 
   ...
   'improvedVentilation': GenericOptionalDevice.VENTILATION, 
   'tankRammer': GenericOptionalDevice.RAMMER, 
   'additionalInvisibilityDevice': GenericOptionalDevice.ADDIT_INVISIBILITY_DEVICE, 
   'extraHealthReserve': GenericOptionalDevice.HEALTH_RESERVE, 
   'improvedRadioCommunication': GenericOptionalDevice.RADIO_COMMUNICATION, 
   'improvedRotationMechanism': GenericOptionalDevice.ROTATION_MECHANISM, 
