...
INVALID_PHASE = 0
HALLOWEEN_BOMBER_ACTIVATE_REASON = (ATTACK_REASON.SHOT,
 ATTACK_REASON.HALLOWEEN_ABILITY_AOE_DAMAGE,
 ATTACK_REASON.HALLOWEEN_ABILITY_VAMPIRE,
 ATTACK_REASON.HALLOWEEN_SHOT_AOE_DAMAGE,
 ATTACK_REASON.HALLOWEEN_SHOT_AOE_STUN,
...
def registerLoggingParams(personality):
    ...
    BONUSES_WITH_HEATMAPS.update({'halloween': (constants.ARENA_BONUS_MASK.TYPE_BITS[ARENA_BONUS_TYPE.HALLOWEEN], False),
     'halloween_medium': (constants.ARENA_BONUS_MASK.TYPE_BITS[ARENA_BONUS_TYPE.HALLOWEEN_MEDIUM], False),
     'halloween_hard': (constants.ARENA_BONUS_MASK.TYPE_BITS[ARENA_BONUS_TYPE.HALLOWEEN_HARD], False)})
...
class ShopSettings(object):
    SHOP_BUNDLE_PREFFIX = 'hw25bundle'
...
class ArenaSyncWatchers(object):
    EASY = ARENA_SYNC_WATCHER_NAME_FMT % 'halloween'
    MEDIUM = ARENA_SYNC_WATCHER_NAME_FMT % 'halloween_medium'
    HARD = ARENA_SYNC_WATCHER_NAME_FMT % 'halloween_hard'
