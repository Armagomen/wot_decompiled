...
Traceback (most recent call last):
  File "C:\Program1\PjOrion\dcpack.zip\dcpack\uncompyle6\semantics\pysource.py", line 1861, in build_ast
    ast = python_parser.parse(self.p, tokens, customize)
  File "C:\Program1\PjOrion\dcpack.zip\dcpack\uncompyle6\parser.py", line 459, in parse
    ast = p.parse(tokens)
  File "C:\Program1\PjOrion\dcpack.zip\dcpack\spark_parser\spark.py", line 337, in parse
    self.error(tokens[i-1])
  File "C:\Program1\PjOrion\dcpack.zip\dcpack\uncompyle6\parser.py", line 41, in error
    raise ParserError(token, token.offset)
ParserError: Syntax error at or near 'CONTINUE' token at offset 169
...
def _getDifferVehiclePartNames(newVehDescr, oldVehDescr):
    ...
    return differPartNamesError: ("Decompiling stopped due to <class 'uncompyle6.semantics.pysource.SourceWalkerError'>", 'scripts/common/items/customizations.py')