...
class BATTLE_CHAT_COMMAND_NAMES(object):
    ...
    MOVE_TO_TARGET_POINT = 'MOVE_TO_TARGET_POINT'
    MOVING_TO_TARGET_POINT = 'MOVING_TO_TARGET_POINT'
...
class LocationMarkerSubType(Enum):
    ...
    TARGET_DESIGNATOR_UNSPOTTED_MARKER_HIT = 'unspottedMarkerHit'
